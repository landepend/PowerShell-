...
(() => {
  ...
  var y = (n10, i, e, t) => {
    for (var r = t > 1 ? void 0 : t ? kn(i, e) : i, s = n10.length - 1, o; s >= 0; s--) (o = n10[s]) && (r = (t ? o(i, e, r) : o(r)) || r);
  ...
  function Fr(n10, i, e) {
    let t = e.getBoundingClientRect(), r = n10.clientX - t.left - 10, s = n10.clientY - t.top - 10;
    i.style.width = "20px", i.style.height = "20px", i.style.left = `${r}px`, i.style.top = `${s}px`, i.style.zIndex = "1000", i.focus();
  }
  ...
  function ye(n10, i = 0, e = n10.length) {
    ...
    for (let r = i; r < e; ++r) {
      let s = n10[r];
      s > 65535 ? (s -= 65536, t += String.fromCharCode((s >> 10) + 55296) + String.fromCharCode(s % 1024 + 56320)) : t += String.fromCharCode(s);
    }
    return t;
  }
  var mi = class {
    ...
    decode(i, e) {
      ...
      for (let o = s; o < t; ++o) {
        ...
        if (55296 <= a && a <= 56319) {
          if (++o >= t) return this._interim = a, r;
          let l = i.charCodeAt(o);
          56320 <= l && l <= 57343 ? e[r++] = (a - 55296) * 1024 + l - 56320 + 65536 : (e[r++] = a, e[r++] = l);
          continue;
        }
        a !== 65279 && (e[r++] = a);
      }
      ...
      if (this.interim[0]) {
        ...
        for (; d < I; ) {
          ...
          if (f = i[d++], (f & 192) !== 128) {
            d--, _ = true;
            break;
          } else this.interim[v++] = f, p <<= 6, p |= f & 63;
        }
        _ || (S === 2 ? p < 128 ? d-- : e[r++] = p : S === 3 ? p < 2048 || p >= 55296 && p <= 57343 || p === 65279 || (e[r++] = p) : p < 65536 || p > 1114111 || (e[r++] = p)), this.interim.fill(0);
      }
      let c = t - 4, u = d;
      for (; u < t; ) {
        for (; u < c && !((s = i[u]) & 128) && !((o = i[u + 1]) & 128) && !((a = i[u + 2]) & 128) && !((l = i[u + 3]) & 128); ) e[r++] = s, e[r++] = o, e[r++] = a, e[r++] = l, u += 4;
        if (s = i[u++], s < 128) e[r++] = s;
        else if ((s & 224) === 192) {
          if (u >= t) return this.interim[0] = s, r;
          if (o = i[u++], (o & 192) !== 128) {
            u--;
            continue;
          }
          if (h = (s & 31) << 6 | o & 63, h < 128) {
            u--;
            continue;
          }
          e[r++] = h;
          ...
          if (u >= t) return this.interim[0] = s, this.interim[1] = o, r;
          if (a = i[u++], (a & 192) !== 128) {
            u--;
            continue;
          }
          if (h = (s & 15) << 12 | (o & 63) << 6 | a & 63, h < 2048 || h >= 55296 && h <= 57343 || h === 65279) continue;
          e[r++] = h;
        } else if ((s & 248) === 240) {
          if (u >= t) return this.interim[0] = s, r;
          if (o = i[u++], (o & 192) !== 128) {
          ...
          if (u >= t) return this.interim[0] = s, this.interim[1] = o, this.interim[2] = a, r;
          if (l = i[u++], (l & 192) !== 128) {
            u--;
            continue;
          }
          if (h = (s & 7) << 18 | (o & 63) << 12 | (a & 63) << 6 | l & 63, h < 65536 || h > 1114111) continue;
          e[r++] = h;
        }
      }
      return r;
    ...
    setFromCharData(e) {
      ...
      if (e[1].length > 2) t = true;
        ...
        if (55296 <= r && r <= 56319) {
          ...
          56320 <= s && s <= 57343 ? this.content = (r - 55296) * 1024 + s - 56320 + 65536 | e[2] << 22 : t = true;
        } else t = true;
  ...
  var et = class {
    ...
    provideLinks(i, e) {
      ...
      let r = [], s = this._optionsService.rawOptions.linkHandler, o = this._workCell, a = t.getTrimmedLength(), l = -1, h = -1, d = false;
      for (let c = 0; c < a; c++) if (!(h === -1 && !t.hasContent(c))) {
        if (t.loadCell(c, o), o.hasExtendedAttrs() && o.extended.urlId) if (h === -1) {
          h = c, l = o.extended.urlId;
          continue;
        } else d = o.extended.urlId !== l;
        else h !== -1 && (d = true);
        if (d || h !== -1 && c === a - 1) {
          let u = this._oscLinkService.getLinkData(l)?.uri;
          if (u) {
            let _ = c + (!d && c === a - 1 ? 1 : 0), p = this._getRangeWithLineWrap(i, h, _, l), v = false;
            if (!s?.allowNonHttpProtocols) try {
              let f = new URL(u);
              ["http:", "https:"].includes(f.protocol) || (v = true);
            } catch {
              v = true;
            }
            v || r.push({ text: u, range: p, activate: (f, S) => s ? s.activate(f, S, p) : Hn(f, S), hover: (f, S) => s?.hover?.(f, S, p), leave: (f, S) => s?.leave?.(f, S, p) });
          }
          d = false, o.hasExtendedAttrs() && o.extended.urlId ? (h = c, l = o.extended.urlId) : (h = -1, l = -1);
        }
      }
      e(r);
    }
    _getRangeWithLineWrap(i, e, t, r) {
      let s = i, o = e, a = i, l = t;
      for (; o === 0 && this._bufferService.buffer.lines.get(s - 1)?.isWrapped; ) {
        let d = this._bufferService.buffer.lines.get(s - 2);
        if (!d) break;
      ...
      return { start: { x: o + 1, y: s }, end: { x: l, y: a } };
    }
    _hasUrlId(i, e, t) {
...
WARNING: This link could potentially be dangerous`)) {
  ...
  var jr = class {
    ...
    static getPositionOfChildWindowRelativeToAncestorWindow(i, e) {
      ...
      let t = 0, r = 0, s = this._getSameOriginWindowChain(i);
      for (let o of s) {
        let a = o.window.deref();
        if (t += a?.scrollY ?? 0, r += a?.scrollX ?? 0, a === e || !o.iframeElement) break;
  ...
  var Gt = class {
    constructor(i, e = 0, t = 0) {
      ...
      let r = false;
      if (Kt) {
        let s = navigator.userAgent.match(/Chrome\/(\d+)/);
        r = (s ? parseInt(s[1], 10) : 123) <= 122;
      }
      if (i) {
        let s = i, o = i, a = i.view?.devicePixelRatio ?? 1;
        if (typeof s.wheelDeltaY < "u") r ? this.deltaY = s.wheelDeltaY / (120 * a) : this.deltaY = s.wheelDeltaY / 120;
        else if (typeof o.VERTICAL_AXIS < "u" && o.axis === o.VERTICAL_AXIS) this.deltaY = -o.detail / 3;
        else if (i.type === "wheel") {
          let l = i;
          l.deltaMode === l.DOM_DELTA_LINE ? nt && !ie ? this.deltaY = -i.deltaY / 3 : this.deltaY = -i.deltaY : this.deltaY = -i.deltaY / 40;
        }
        if (typeof s.wheelDeltaX < "u") wi && Ue ? this.deltaX = -(s.wheelDeltaX / 120) : r ? this.deltaX = s.wheelDeltaX / (120 * a) : this.deltaX = s.wheelDeltaX / 120;
        else if (typeof o.HORIZONTAL_AXIS < "u" && o.axis === o.HORIZONTAL_AXIS) this.deltaX = -i.detail / 3;
        else if (i.type === "wheel") {
          let l = i;
          l.deltaMode === l.DOM_DELTA_LINE ? nt && !ie ? this.deltaX = -i.deltaX / 3 : this.deltaX = -i.deltaX : this.deltaX = -i.deltaX / 40;
        }
  ...
  var at = class {
    ...
    startMonitoring(i, e, t, r, s) {
      this.isMonitoring() && this.stopMonitoring(false), this._pointerMoveCallback = r, this._onStopCallback = s;
      let o = i;
      try {
      ...
      this._hooks.add(C(o, le.POINTER_MOVE, (a) => {
        if (a.buttons !== t) {
          this.stopMonitoring(true);
          return;
        }
        a.preventDefault(), this._pointerMoveCallback(a);
      })), this._hooks.add(C(o, le.POINTER_UP, (a) => this.stopMonitoring(true)));
    }
  };
  ...
  var b = class {
    ...
    get event() {
      return this._event ? this._event : (this._event = (i, e, t) => {
        ...
        let s = E(() => {
          let o = this._listeners.indexOf(r);
          o !== -1 && this._listeners.splice(o, 1);
        });
        return t && (Array.isArray(t) ? t.push(s) : t.add(s)), s;
      }, this._event);
    }
    fire(i) {
  ...
  ((r) => {
    ...
    r.forward = n10;
    function i(s, o) {
      return (a, l, h) => s((d) => a.call(l, o(d)), void 0, h);
    }
    r.map = i;
    function e(...s) {
      return (o, a, l) => {
        let h = new pe();
        for (let d of s) h.add(d((c) => o.call(a, c)));
        return l && (Array.isArray(l) ? l.push(h) : l.add(h)), h;
      };
    }
    r.any = e;
    function t(s, o, a) {
  ...
  var Jr = class n4 {
    constructor(i, e, t, r, s, o, a) {
      this._forceIntegerValues = i;
      this._scrollStateBrand = void 0;
      this._forceIntegerValues && (e = e | 0, t = t | 0, r = r | 0, s = s | 0, o = o | 0, a = a | 0), this.rawScrollLeft = r, this.rawScrollTop = a, e < 0 && (e = 0), r + e > t && (r = t - e), r < 0 && (r = 0), s < 0 && (s = 0), a + s > o && (a = o - s), a < 0 && (a = 0), this.width = e, this.scrollWidth = t, this.scrollLeft = r, this.height = s, this.scrollHeight = o, this.scrollTop = a;
    }
    equals(i) {
    ...
    createScrollEvent(i, e) {
      let t = this.width !== i.width, r = this.scrollWidth !== i.scrollWidth, s = this.scrollLeft !== i.scrollLeft, o = this.height !== i.height, a = this.scrollHeight !== i.scrollHeight, l = this.scrollTop !== i.scrollTop;
  ...
  var lt = class extends g {
    ...
    setScrollPositionSmooth(e, t) {
      ...
      if (this._smoothScrolling) {
        ...
        let s;
        t ? s = new Vt(this._smoothScrolling.from, r, this._smoothScrolling.startTime, this._smoothScrolling.duration) : s = Vt.start(this._state, r, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = s;
      } else {
        let r = this._state.withScrollPosition(e);
  ...
  var Vt = class n5 {
    ...
    _initAnimation(i, e, t) {
      if (Math.abs(i - e) > 2.5 * t) {
        let s, o;
        return i < e ? (s = i + 0.75 * t, o = e - 0.75 * t) : (s = i - 0.75 * t, o = e + 0.75 * t), Gn(Zr(i, s), Zr(o, e), 0.33);
      }
      return Zr(i, e);
    }
    dispose() {
  ...
  var ct = class extends Ne {
    ...
    delegatePointerDown(i) {
      let e = this.domNode.domNode.getClientRects()[0].top, t = e + this._scrollbarState.getSliderPosition(), r = e + this._scrollbarState.getSliderPosition() + this._scrollbarState.getSliderSize(), s = this._sliderPointerPosition(i);
      t <= s && s <= r ? i.button === 0 && (i.preventDefault(), this._sliderPointerDown(i)) : this._handlePointerDown(i);
    }
    _handlePointerDown(i) {
      ...
      if (i.target === this.domNode.domNode && typeof i.offsetX == "number" && typeof i.offsetY == "number") e = i.offsetX, t = i.offsetY;
        ...
        let s = $s(this.domNode.domNode);
        e = i.pageX - s.left, t = i.pageY - s.top;
      }
    ...
    _sliderPointerDown(i) {
      ...
      this.slider.toggleClassName("xterm-active", true), this._pointerMoveMonitor.startMonitoring(i.target, i.pointerId, i.buttons, (s) => {
        let o = this._sliderOrthogonalPointerPosition(s), a = Math.abs(o - t);
        if (Ue && a > qn) {
          this._setDesiredScrollPositionNow(r.getScrollPosition());
          return;
        }
        let h = this._sliderPointerPosition(s) - e;
  ...
  var ht = class n6 {
    constructor(i, e, t, r, s, o) {
      this._scrollbarSize = Math.round(e), this._oppositeScrollbarSize = Math.round(t), this._arrowSize = Math.round(i), this._visibleSize = r, this._scrollSize = s, this._scrollPosition = o, this._computedAvailableSize = 0, this._computedIsNeeded = false, this._computedSliderSize = 0, this._computedSliderRatio = 0, this._computedSliderPosition = 0, this._refreshComputedValues();
    }
    clone() {
    ...
    static _computeValues(i, e, t, r, s) {
      let o = Math.max(0, t - i), a = Math.max(0, o - 2 * e), l = r > 0 && r > t;
      ...
      let h = Math.round(Math.max(20, Math.floor(t * a / r))), d = (a - h) / (r - t), c = s * d;
      return { computedAvailableSize: Math.round(o), computedIsNeeded: l, computedSliderSize: Math.round(h), computedSliderRatio: d, computedSliderPosition: Math.round(c) };
    }
  ...
  var Ai = class extends ct {
    constructor(i, e, t) {
      let r = i.getScrollDimensions(), s = i.getCurrentScrollPosition();
      if (super({ lazyRender: e.lazyRender, host: t, scrollbarState: new ht(e.horizontalHasArrows ? e.horizontalScrollbarSize : 0, e.horizontal === 2 ? 0 : e.horizontalScrollbarSize, e.vertical === 2 ? 0 : e.verticalScrollbarSize, r.width, r.scrollWidth, s.scrollLeft), visibility: e.horizontal, extraScrollbarClassName: "xterm-horizontal", scrollable: i, scrollByPage: e.scrollByPage }), e.horizontalHasArrows) throw new Error("horizontalHasArrows is not supported in xterm.js");
  ...
  var ki = class extends ct {
    constructor(e, t, r) {
      let s = e.getScrollDimensions(), o = e.getCurrentScrollPosition(), a = t.verticalHasArrows;
      super({ lazyRender: t.lazyRender, host: r, scrollbarState: new ht(a ? t.verticalScrollbarSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, s.height, s.scrollHeight, o.scrollTop), visibility: t.vertical, extraScrollbarClassName: "xterm-vertical", scrollable: e, scrollByPage: t.scrollByPage });
  ...
  var Bi = class Bi2 {
    ...
    isPhysicalMouseWheel() {
      ...
      for (; r !== -1; ) {
        let s = r === this._front ? i : Math.pow(2, -t);
        if (i -= s, e += this._memory[r].score * s, r === this._front) break;
    ...
    _computeScore(i, e) {
      ...
      if ((!this._isAlmostInt(i.deltaX) || !this._isAlmostInt(i.deltaY)) && (t += 0.25), e) {
        let r = Math.abs(i.deltaX), s = Math.abs(i.deltaY), o = Math.abs(e.deltaX), a = Math.abs(e.deltaY), l = Math.max(Math.min(r, o), 1), h = Math.max(Math.min(s, a), 1), d = Math.max(r, o), c = Math.max(s, a);
        d % l === 0 && c % h === 0 && (t -= 0.5);
      }
  ...
  var Mi = class extends Ne {
    ...
    _setListeningToMouseWheel(e) {
      if (this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Oe(this._mouseWheelToDispose), e)) {
        let r = (s) => {
          this._handleMouseWheel(new Gt(s));
        };
    ...
    _handleMouseWheel(e) {
      ...
      if (e.deltaY || e.deltaX) {
        ...
        let l = !ie && e.browserEvent && e.browserEvent.shiftKey;
        ...
        if (o) {
          let c = 50 * o, u = h.scrollTop - (c < 0 ? Math.floor(c) : Math.ceil(c));
      ...
      let s = r;
      !s && this._options.alwaysConsumeMouseWheel && (s = true), !s && this._options.consumeMouseWheelIfScrollbarIsNeeded && (this._verticalScrollbar.isNeeded() || this._horizontalScrollbar.isNeeded()) && (s = true), s && (e.preventDefault(), e.stopPropagation());
    }
    _handleScroll(e) {
    ...
    _render() {
      if (this._shouldRender && (this._shouldRender = false, this._horizontalScrollbar.render(), this._verticalScrollbar.render(), this._options.useShadows)) {
        ...
        this._leftShadowDomNode.setClassName(`xterm-shadow${s}`), this._topShadowDomNode.setClassName(`xterm-shadow${o}`), this._topLeftShadowDomNode.setClassName(`xterm-shadow${a}${o}${s}`);
      }
    }
    _handleDragStart() {
  ...
  var dt = class extends g {
    constructor(e, t, r, s, o, a, l, h, d) {
      ...
      let c = this._register(new lt({ forceIntegerValues: false, smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration, scheduleAtNextAnimationFrame: (u) => tt(s.window, u) }));
      ...
      })), this._scrollableElement.setScrollDimensions({ height: 0, scrollHeight: 0 }), this._register(j.runAndSubscribe(l.onChangeColors, () => {
        e.style.backgroundColor = l.colors.background.css, this._scrollableElement.getDomNode().style.backgroundColor = l.colors.background.css;
      })), e.appendChild(this._scrollableElement.getDomNode()), this._register(E(() => this._scrollableElement.getDomNode().remove())), this._styleElement = s.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(E(() => this._styleElement.remove())), this._register(j.runAndSubscribe(l.onChangeColors, () => {
        this._styleElement.textContent = [".xterm .xterm-scrollable-element > .xterm-scrollbar > .xterm-slider {", `  background: ${l.colors.scrollbarSliderBackground.css};`, "}", ".xterm .xterm-scrollable-element > .xterm-scrollbar > .xterm-slider:hover {", `  background: ${l.colors.scrollbarSliderHoverBackground.css};`, "}", ".xterm .xterm-scrollable-element > .xterm-scrollbar > .xterm-slider.xterm-active {", `  background: ${l.colors.scrollbarSliderActiveBackground.css};`, "}"].join(`
`);
        ...
        this._isSendingComposition = true, setTimeout(() => {
          if (this._isSendingComposition) {
            ...
            if (e.start += this._dataAlreadySent.length, this._isComposing) r = this._textarea.value.substring(e.start, this._compositionPosition.start);
              ...
              let s = this._textarea.value, o = t.length > 0 && s.endsWith(t) ? s.length - t.length : s.length;
              r = s.substring(e.start, Math.max(e.start, o));
            }
    ...
    updateCompositionElements(i) {
      if (this._isComposing) {
        if (this._bufferService.buffer.isCursorInViewport) {
          let e = Math.min(this._bufferService.buffer.x, this._bufferService.cols - 1), t = this._renderService.dimensions.css.cell.height, r = this._bufferService.buffer.y * this._renderService.dimensions.css.cell.height, s = e * this._renderService.dimensions.css.cell.width;
          this._compositionView.style.left = s + "px", this._compositionView.style.top = r + "px", this._compositionView.style.height = t + "px", this._compositionView.style.lineHeight = t + "px", this._compositionView.style.fontFamily = this._optionsService.rawOptions.fontFamily, this._compositionView.style.fontSize = this._optionsService.rawOptions.fontSize + "px";
          let o = this._bufferService.cols * this._renderService.dimensions.css.cell.width - s;
          this._compositionView.style.maxWidth = o + "px", this._compositionView.style.overflow = "hidden", this._compositionView.style.direction = "rtl";
          let a = this._compositionView.getBoundingClientRect();
          this._textarea.style.left = s + "px", this._textarea.style.top = r + "px", this._textarea.style.width = Math.max(a.width, 1) + "px", this._textarea.style.height = Math.max(a.height, 1) + "px", this._textarea.style.lineHeight = a.height + "px";
        }
  ...
  var O;
  ((t) => {
    function n10(r, s, o, a) {
      return a !== void 0 ? `#${Ve(r)}${Ve(s)}${Ve(o)}${Ve(a)}` : `#${Ve(r)}${Ve(s)}${Ve(o)}`;
    }
    t.toCss = n10;
    function i(r, s, o, a = 255) {
      return (r << 24 | s << 16 | o << 8 | a) >>> 0;
    }
    t.toRgba = i;
    function e(r, s, o, a) {
      return { css: t.toCss(r, s, o, a), rgba: t.toRgba(r, s, o, a) };
    }
    t.toColor = e;
  })(O ||= {});
  var k;
  ((a) => {
    function n10(l, h) {
      ...
      let d = h.rgba >> 24 & 255, c = h.rgba >> 16 & 255, u = h.rgba >> 8 & 255, _ = l.rgba >> 24 & 255, p = l.rgba >> 16 & 255, v = l.rgba >> 8 & 255;
      J = _ + Math.round((d - _) * W), Q = p + Math.round((c - p) * W), ee = v + Math.round((u - v) * W);
      let f = O.toCss(J, Q, ee), S = O.toRgba(J, Q, ee);
      return { css: f, rgba: S };
    }
    a.blend = n10;
    function i(l) {
    ...
    a.isOpaque = i;
    function e(l, h, d) {
      let c = Oi.ensureContrastRatio(l.rgba, h.rgba, d);
    ...
    a.opaque = t;
    function r(l, h) {
      return W = Math.round(h * 255), [J, Q, ee] = Oi.toChannels(l.rgba), { css: O.toCss(J, Q, ee, W), rgba: O.toRgba(J, Q, ee, W) };
    }
    a.opacity = r;
    function s(l, h) {
      return W = l.rgba & 255, r(l, W * h / 255);
    }
    a.multiplyOpacity = s;
    function o(l) {
  ...
  ((t) => {
    ...
    try {
      ...
      let s = r.getContext("2d", { willReadFrequently: true });
      s && (n10 = s, n10.globalCompositeOperation = "copy", i = n10.createLinearGradient(0, 0, 1, 1));
    } catch {
    }
    function e(r) {
      ...
      let s = r.match(/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(,\s*(0|1|\d?\.(\d+))\s*)?\)/);
      if (s) return J = parseInt(s[1], 10), Q = parseInt(s[2], 10), ee = parseInt(s[3], 10), W = Math.round((s[5] === void 0 ? 1 : parseFloat(s[5])) * 255), O.toColor(J, Q, ee, W);
  ...
  ((e) => {
    ...
    function i(t, r, s) {
      let o = t / 255, a = r / 255, l = s / 255, h = o <= 0.03928 ? o / 12.92 : Math.pow((o + 0.055) / 1.055, 2.4), d = a <= 0.03928 ? a / 12.92 : Math.pow((a + 0.055) / 1.055, 2.4), c = l <= 0.03928 ? l / 12.92 : Math.pow((l + 0.055) / 1.055, 2.4);
  ...
  ((s) => {
    function n10(o, a) {
      ...
      let l = a >> 24 & 255, h = a >> 16 & 255, d = a >> 8 & 255, c = o >> 24 & 255, u = o >> 16 & 255, _ = o >> 8 & 255;
      return J = c + Math.round((l - c) * W), Q = u + Math.round((h - u) * W), ee = _ + Math.round((d - _) * W), O.toRgba(J, Q, ee);
    }
    s.blend = n10;
    function i(o, a, l) {
      let h = Z.relativeLuminance(o >> 8), d = Z.relativeLuminance(a >> 8);
      if (Te(h, d) < l) {
        if (d < h) {
          let p = e(o, a, l), v = Te(h, Z.relativeLuminance(p >> 8));
          if (v < l) {
            let f = t(o, a, l), S = Te(h, Z.relativeLuminance(f >> 8));
            return v > S ? p : f;
          }
          return p;
        }
        let u = t(o, a, l), _ = Te(h, Z.relativeLuminance(u >> 8));
        if (_ < l) {
          let p = e(o, a, l), v = Te(h, Z.relativeLuminance(p >> 8));
          return _ > v ? u : p;
        }
    ...
    s.ensureContrastRatio = i;
    function e(o, a, l) {
      let h = o >> 24 & 255, d = o >> 16 & 255, c = o >> 8 & 255, u = a >> 24 & 255, _ = a >> 16 & 255, p = a >> 8 & 255, v = Te(Z.relativeLuminance2(u, _, p), Z.relativeLuminance2(h, d, c));
      for (; v < l && (u > 0 || _ > 0 || p > 0); ) u -= Math.max(0, Math.ceil(u * 0.1)), _ -= Math.max(0, Math.ceil(_ * 0.1)), p -= Math.max(0, Math.ceil(p * 0.1)), v = Te(Z.relativeLuminance2(u, _, p), Z.relativeLuminance2(h, d, c));
      return (u << 24 | _ << 16 | p << 8 | 255) >>> 0;
    }
    s.reduceLuminance = e;
    function t(o, a, l) {
      let h = o >> 24 & 255, d = o >> 16 & 255, c = o >> 8 & 255, u = a >> 24 & 255, _ = a >> 16 & 255, p = a >> 8 & 255, v = Te(Z.relativeLuminance2(u, _, p), Z.relativeLuminance2(h, d, c));
      for (; v < l && (u < 255 || _ < 255 || p < 255); ) u = Math.min(255, u + Math.ceil((255 - u) * 0.1)), _ = Math.min(255, _ + Math.ceil((255 - _) * 0.1)), p = Math.min(255, p + Math.ceil((255 - p) * 0.1)), v = Te(Z.relativeLuminance2(u, _, p), Z.relativeLuminance2(h, d, c));
      return (u << 24 | _ << 16 | p << 8 | 255) >>> 0;
    }
    s.increaseLuminance = t;
    function r(o) {
  ...
  var He = class {
    ...
    getJoinedCharacters(i) {
      ...
      let t = [], r = e.translateToString(true), s = e.getTrimmedLength(), o = 0, a = 0, l = 0, h = e.getFg(0), d = e.getBg(0);
      for (let c = 0; c < s; c++) if (e.loadCell(c, this._workCell), this._workCell.getWidth() !== 0) {
        if (this._workCell.fg !== h || this._workCell.bg !== d) {
          if (c - o > 1) {
            let u = this._getJoinedRanges(r, l, a, e, o);
            for (let _ = 0; _ < u.length; _++) t.push(u[_]);
          }
          o = c, l = a, h = this._workCell.fg, d = this._workCell.bg;
        }
        a += this._workCell.getChars().length || " ".length;
      }
      if (s - o > 1) {
        let c = this._getJoinedRanges(r, l, a, e, o);
        for (let u = 0; u < c.length; u++) t.push(c[u]);
      }
      return t;
    }
    _getJoinedRanges(i, e, t, r, s) {
      let o = i.substring(e, t), a = [];
      try {
      ...
      for (let l = 1; l < this._characterJoiners.length; l++) try {
        let h = this._characterJoiners[l].handler(o);
        for (let d = 0; d < h.length; d++) He._mergeRanges(a, h[d]);
      } catch (h) {
        console.error(h);
      }
      return this._stringRangesToCellRanges(a, r, s), a;
    }
    _stringRangesToCellRanges(i, e, t) {
      let r = 0, s = false, o = 0, a = i[r];
      if (!a) return;
      let l = e.getTrimmedLength();
      for (let h = t; h < l; h++) {
        let d = e.getWidth(h), c = e.getString(h).length || " ".length;
        if (d !== 0) {
          if (!s && a[0] <= o && (a[0] = h, s = true), a[1] <= o) {
            if (a[1] = h, a = i[++r], !a) break;
            a[0] <= o ? (a[0] = h, s = true) : s = false;
          }
          o += c;
        }
      }
    ...
    static _mergeRanges(i, e) {
      ...
      for (let r = 0; r < i.length; r++) {
        let s = i[r];
        if (t) {
          if (e[1] <= s[0]) return i[r - 1][1] = e[1], i;
          if (e[1] <= s[1]) return i[r - 1][1] = Math.max(e[1], s[1]), i.splice(r, 1), i;
          i.splice(r, 1), r--;
        } else {
          if (e[1] <= s[0]) return i.splice(r, 0, e), i;
          if (e[1] <= s[1]) return s[0] = Math.min(e[0], s[0]), i;
          e[0] < s[1] && (s[0] = Math.min(e[0], s[0]), t = true);
          continue;
        }
      }
  ...
  var _t = class {
    ...
    createRow(i, e, t, r, s, o, a, l, h, d, c, u, _) {
      let p = [];
      _ && (_.hasBlinkingCells = false);
      let v = this._characterJoinerService.getJoinedCharacters(e), f = this._themeService.colors, S = i.getNoBgTrimmedLength();
      t && S < o + 1 && (S = o + 1);
      let I, w = 0, L = "", T, te = 0, Ds = 0, Rs = 0, Ls = false, As = 0, ui = false, Ot, ks = 0, N = [], An = c !== -1 && u !== -1;
      for (let ae = 0; ae < S; ae++) {
        i.loadCell(ae, this._workCell);
        let Rr = this._workCell.getWidth();
        if (Rr === 0) continue;
        let fi = false, je = ae >= ks, Lr = ae, x = this._workCell;
        if (v.length > 0 && ae === v[0][0] && je) {
          let A = v.shift(), Pr = this._isCellInSelection(A[0], e);
          for (T = A[0] + 1; T < A[1]; T++) je &&= Pr === this._isCellInSelection(T, e);
          je &&= !t || o < A[0] || o >= A[1], je ? (fi = true, x = new Ni(this._workCell, i.translateToString(true, A[0], A[1]), A[1] - A[0]), Lr = A[1] - 1, Rr = x.getWidth()) : ks = A[1];
        }
        let Nt = this._isCellInSelection(ae, e), Ar = t && ae === o, kr = An && ae >= c && ae <= u;
        _ && x.isBlink() && (_.hasBlinkingCells = true), !l && x.isBlink() && N.push("xterm-blink-hidden");
        let Mr = false;
        this._decorationService.forEachDecorationAtCell(ae, e, void 0, (A) => {
          Mr = true;
        });
        let _i = x.getChars() || " ";
        if (_i === " " && (x.isUnderline() || x.isOverline()) && (_i = "\xA0"), Ot = Rr * h - d.get(_i, x.isBold(), x.isItalic()), !I) I = this._document.createElement("span");
        else if (w && (Nt && ui || !Nt && !ui && x.bg === te) && (Nt && ui && f.selectionForeground || x.fg === Ds) && x.extended.ext === Rs && kr === Ls && Ot === As && !Ar && !fi && !Mr && je) {
          x.isInvisible() ? L += " " : L += _i, w++;
          continue;
        } else w && (I.textContent = L), I = this._document.createElement("span"), w = 0, L = "";
        if (te = x.bg, Ds = x.fg, Rs = x.extended.ext, Ls = kr, As = Ot, ui = Nt, fi && o >= ae && o <= Lr && (o = ae), !this._coreService.isCursorHidden && Ar && this._coreService.isCursorInitialized) {
          if (N.push("xterm-cursor"), this._coreBrowserService.isFocused) a && N.push("xterm-cursor-blink"), N.push(r === "bar" ? "xterm-cursor-bar" : r === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
          else if (s) switch (s) {
            case "outline":
              N.push("xterm-cursor-outline");
              break;
            case "block":
              N.push("xterm-cursor-block");
              break;
            case "bar":
              N.push("xterm-cursor-bar");
              break;
            case "underline":
              N.push("xterm-cursor-underline");
              break;
            default:
              break;
          }
        }
        if (x.isBold() && N.push("xterm-bold"), x.isItalic() && N.push("xterm-italic"), x.isDim() && N.push("xterm-dim"), x.isInvisible() ? L = " " : L = x.getChars() || " ", x.isUnderline() && (N.push(`xterm-underline-${x.extended.underlineStyle}`), L === " " && (L = "\xA0"), !x.isUnderlineColorDefault())) if (x.isUnderlineColorRGB()) I.style.textDecorationColor = `rgb(${ue.toColorRGB(x.getUnderlineColor()).join(",")})`;
        else {
          let A = x.getUnderlineColor();
          this._optionsService.rawOptions.drawBoldTextInBrightColors && x.isBold() && A < 8 && (A += 8), I.style.textDecorationColor = f.ansi[A].css;
        }
        x.isOverline() && (N.push("xterm-overline"), L === " " && (L = "\xA0")), x.isStrikethrough() && N.push("xterm-strikethrough"), kr && (I.style.textDecoration = "underline");
        let de = x.getFgColor(), Ft = x.getFgColorMode(), Se = x.getBgColor(), Ht = x.getBgColorMode(), Br = !!x.isInverse();
        if (Br) {
          let A = de;
          de = Se, Se = A;
          let Pr = Ft;
        ...
        let Le, pi, Wt = false;
        this._decorationService.forEachDecorationAtCell(ae, e, void 0, (A) => {
          A.options.layer !== "top" && Wt || (A.backgroundColorRGB && (Ht = 50331648, Se = A.backgroundColorRGB.rgba >> 8 & 16777215, Le = A.backgroundColorRGB), A.foregroundColorRGB && (Ft = 50331648, de = A.foregroundColorRGB.rgba >> 8 & 16777215, pi = A.foregroundColorRGB), Wt = A.options.layer === "top");
        }), !Wt && Nt && (Le = this._coreBrowserService.isFocused ? f.selectionBackgroundOpaque : f.selectionInactiveBackgroundOpaque, Se = Le.rgba >> 8 & 16777215, Ht = 50331648, Wt = true, f.selectionForeground && (Ft = 50331648, de = f.selectionForeground.rgba >> 8 & 16777215, pi = f.selectionForeground)), Wt && N.push("xterm-decoration-top");
        let Ae;
        switch (Ht) {
          case 16777216:
          case 33554432:
            Ae = f.ansi[Se], N.push(`xterm-bg-${Se}`);
            break;
          case 50331648:
            Ae = O.toColor(Se >> 16, Se >> 8 & 255, Se & 255), this._addStyle(I, `background-color:#${(Se >>> 0).toString(16).padStart(6, "0")}`);
            break;
          case 0:
          default:
            Br ? (Ae = f.foreground, N.push(`xterm-bg-${257}`)) : Ae = f.background;
        }
        switch (Le || x.isDim() && (Le = k.multiplyOpacity(Ae, 0.5)), Ft) {
          case 16777216:
          case 33554432:
            x.isBold() && de < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (de += 8), this._applyMinimumContrast(I, Ae, f.ansi[de], x, Le, void 0) || N.push(`xterm-fg-${de}`);
            break;
          case 50331648:
            let A = O.toColor(de >> 16 & 255, de >> 8 & 255, de & 255);
            this._applyMinimumContrast(I, Ae, A, x, Le, pi) || this._addStyle(I, `color:#${de.toString(16).padStart(6, "0")}`);
            break;
          case 0:
          default:
            this._applyMinimumContrast(I, Ae, f.foreground, x, Le, pi) || Br && N.push(`xterm-fg-${257}`);
        }
        N.length && (I.className = N.join(" "), N.length = 0), !Ar && !fi && !Mr && je ? w++ : I.textContent = L, Ot !== this.defaultSpacing && (I.style.letterSpacing = `${Ot}px`), p.push(I), ae = Lr;
      }
      return I && w && (I.textContent = L), p;
    }
    _applyMinimumContrast(i, e, t, r, s, o) {
      if (this._optionsService.rawOptions.minimumContrastRatio === 1 || js(r.getCode())) return false;
      let a = this._getContrastCache(r), l;
      if (!s && !o && (l = a.getColor(e.rgba, t.rgba)), l === void 0) {
        let h = this._optionsService.rawOptions.minimumContrastRatio / (r.isDim() ? 2 : 1);
        l = k.ensureContrastRatio(s ?? e, o ?? t, h), a.setColor((s ?? e).rgba, (o ?? t).rgba, l ?? null);
      }
      return l ? (this._addStyle(i, `color:${l.css}`), true) : false;
    }
    _getContrastCache(i) {
  ...
  var Hi = class {
    ...
    get(i, e, t) {
      ...
      let s = i;
      e && (s += "B"), t && (s += "I");
      let o = this._holey.get(s);
      if (o === void 0) {
        let a = 0;
        e && (a |= 1), t && (a |= 2), o = this._measure(i, a), o > 0 && this._holey.set(s, o);
      }
      return o;
    }
    _measure(i, e) {
  ...
  var rs = class {
    ...
    setFont(i, e, t, r) {
      let s = r ? "italic" : "";
      this._ctx.font = `${s} ${t} ${e}px ${i}`.trim();
    }
    measure(i) {
  ...
  var ss = class {
    ...
    update(i, e, t, r = false) {
      ...
      let s = i.buffers.active.ydisp, o = e[1] - s, a = t[1] - s, l = Math.max(o, 0), h = Math.min(a, i.rows - 1);
      if (l >= i.rows || h < 0) {
        this.clear();
        return;
      }
      this.hasSelection = true, this.columnSelectMode = r, this.viewportStartRow = o, this.viewportEndRow = a, this.viewportCappedStartRow = l, this.viewportCappedEndRow = h, this.startCol = e[0], this.endCol = t[0];
    }
  ...
  var Wi = class extends g {
    constructor(e, t, r) {
      ...
      this._register(this._optionsService.onSpecificOptionChange("blinkIntervalDuration", (s) => {
        this.setIntervalDuration(s);
  ...
  var mt = class extends g {
    constructor(e, t, r, s, o, a, l, h, d, c, u, _, p, v) {
      super();
      this._terminal = e;
      this._document = t;
      this._element = r;
    ...
    _refreshRowElements(e, t) {
      for (let r = this._rowElements.length; r <= t; r++) {
        ...
        this._rowContainer.appendChild(s), this._rowElements.push(s), this._rowHasBlinkingCells.push(false);
      }
    ...
    handleSelectionChanged(e, t, r) {
      let s = this._bufferService.rows;
      this._selectionContainer.replaceChildren(), this._rowFactory.handleSelectionChanged(e, t, r);
      let o = 0, a = -1;
      this._lastSelectionStart && this._lastSelectionEnd && (this._selectionRenderModel.update(this._terminal, this._lastSelectionStart, this._lastSelectionEnd, this._lastSelectionColumnMode), this._selectionRenderModel.hasSelection && (o = this._selectionRenderModel.viewportCappedStartRow, a = this._selectionRenderModel.viewportCappedEndRow));
      let l = 0, h = -1;
      if (!e || !t) return;
      if (this._selectionRenderModel.update(this._terminal, e, t, r), this._selectionRenderModel.hasSelection) {
        ...
        l = p, h = v;
        let f = this._document.createDocumentFragment();
        if (r) {
          let S = e[0] > t[0];
          f.appendChild(this._createSelectionElement(p, S ? t[0] : e[0], S ? e[0] : t[0], v - p + 1));
        } else {
          let S = u === p ? e[0] : 0, I = p === _ ? t[0] : this._bufferService.cols;
          f.appendChild(this._createSelectionElement(p, S, I));
          let w = v - p - 1;
          if (f.appendChild(this._createSelectionElement(p + 1, 0, this._bufferService.cols, w)), p !== v) {
            let L = _ === v ? t[0] : this._bufferService.cols;
            f.appendChild(this._createSelectionElement(v, 0, L));
          }
        }
        this._selectionContainer.appendChild(f);
      }
      let d = Math.min(o, l), c = Math.max(a, h);
      if (c >= 0) {
        d = Math.max(d, 0), c = Math.min(c, s - 1);
        let _ = this._bufferService.buffer.y;
        this._selectionRenderModel.hasSelection && _ >= 0 && _ < s && (d = Math.min(d, _), c = Math.max(c, _)), this.renderRows(d, c);
      }
      this._lastSelectionStart = e, this._lastSelectionEnd = t, this._lastSelectionColumnMode = r;
    }
    _createSelectionElement(e, t, r, s = 1) {
      let o = this._document.createElement("div"), a = t * this.dimensions.css.cell.width, l = this.dimensions.css.cell.width * (r - t);
      return a + l > this.dimensions.css.canvas.width && (l = this.dimensions.css.canvas.width - a), o.style.height = `${s * this.dimensions.css.cell.height}px`, o.style.top = `${e * this.dimensions.css.cell.height}px`, o.style.left = `${a}px`, o.style.width = `${l}px`, o;
    }
    handleCursorMove() {
    ...
    renderRows(e, t) {
      let r = this._bufferService.buffer, s = r.ybase + r.y, o = Math.min(r.x, this._bufferService.cols - 1), a = this._coreService.decPrivateModes.cursorBlink ?? this._optionsService.rawOptions.cursorBlink, l = this._coreService.decPrivateModes.cursorStyle ?? this._optionsService.rawOptions.cursorStyle, h = this._optionsService.rawOptions.cursorInactiveStyle, d = { hasBlinkingCells: false };
      for (let c = e; c <= t; c++) {
        ...
        _.replaceChildren(...this._rowFactory.createRow(p, u, u === s, l, h, o, a, this._textBlinkStateManager.isBlinkOn, this.dimensions.css.cell.width, this._widthCache, -1, -1, d)), this._setRowBlinkState(c, d.hasBlinkingCells);
      }
    ...
    _setCellUnderline(e, t, r, s, o, a) {
      r < 0 && (e = 0), s < 0 && (t = 0);
      let l = this._bufferService.rows - 1;
      r = Math.max(Math.min(r, l), 0), s = Math.max(Math.min(s, l), 0), o = Math.min(o, this._bufferService.cols);
      let h = this._bufferService.buffer, d = h.ybase + h.y, c = Math.min(h.x, o - 1), u = this._optionsService.rawOptions.cursorBlink, _ = this._optionsService.rawOptions.cursorStyle, p = this._optionsService.rawOptions.cursorInactiveStyle, v = { hasBlinkingCells: false };
      for (let f = r; f <= s; ++f) {
        let S = f + h.ydisp, I = this._rowElements[f];
        if (!I) continue;
        let w = h.lines.get(S);
        if (!w) {
          I.replaceChildren(), this._setRowBlinkState(f, false);
          continue;
        }
        I.replaceChildren(...this._rowFactory.createRow(w, S, S === d, _, p, c, u, this._textBlinkStateManager.isBlinkOn, this.dimensions.css.cell.width, this._widthCache, a ? f === r ? e : 0 : -1, a ? (f === s ? t : o) - 1 : -1, v)), this._setRowBlinkState(f, v.hasBlinkingCells);
      }
      this._updateTextBlinkState();
    }
  ...
  var Ki = class extends g {
    constructor(e, t, r) {
      ...
      this._screenDprMonitor = this._register(new ls(this._window)), this._register(this.onWindowChange((s) => this._screenDprMonitor.setWindow(s))), this._register(j.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(C(this._textarea, "focus", () => this._isFocused = true)), this._register(C(this._textarea, "blur", () => this._isFocused = false));
    }
    get window() {
      return this._window;
    }
  ...
  function qt(n10, i, e) {
    let t = e.getBoundingClientRect(), r = n10.getComputedStyle(e), s = parseInt(r.getPropertyValue("padding-left"), 10), o = parseInt(r.getPropertyValue("padding-top"), 10);
    return [i.clientX - t.left - s, i.clientY - t.top - o];
  }
  function Qs(n10, i, e, t, r, s, o, a, l) {
    if (!s) return;
    let h = qt(n10, i, e);
    return h[0] = Math.ceil((h[0] + (l ? o / 2 : 0)) / o), h[1] = Math.ceil(h[1] / a), h[0] = Math.min(Math.max(h[0], 1), t + (l ? 1 : 0)), h[1] = Math.min(Math.max(h[1], 1), r), h;
  }
  var vt = class {
    constructor(i, e) {
    ...
    getCoords(i, e, t, r, s) {
      return Qs(se(e), i, e, t, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, s);
    }
  ...
  function Jn(n10, i, e) {
    ...
    let s = `$memoize$${i}`, o = e;
    o[t] = function(...a) {
      return this.hasOwnProperty(s) || Object.defineProperty(this, s, { configurable: false, enumerable: false, writable: false, value: r.apply(this, a) }), this[s];
    };
  }
  var St = class St2 {
    constructor(i) {
  ...
  var Gi = class {
    ...
    _insert(i, e) {
      ...
      if (this._first === re.Undefined) this._first = t, this._last = t;
        ...
        let s = this._last;
        this._last = t, t.prev = s, s.next = t;
      } else {
        let s = this._first;
        this._first = t, t.next = s, s.prev = t;
      }
      let r = false;
      return () => {
  ...
  var he;
  ((s) => (s.TAP = "-xterm-gesturetap", s.CHANGE = "-xterm-gesturechange", s.START = "-xterm-gesturestart", s.END = "-xterm-gesturesend", s.CONTEXT_MENU = "-xterm-gesturecontextmenu"))(he ||= {});
  var K = class K2 extends g {
    ...
    _handleTouchStart(e) {
      ...
      for (let r = 0, s = e.targetTouches.length; r < s; r++) {
        let o = e.targetTouches.item(r);
        this._activeTouches[o.identifier] = { id: o.identifier, initialTarget: o.target, initialTimeStamp: t, initialPageX: o.pageX, initialPageY: o.pageY, rollingTimestamps: [t], rollingPageX: [o.pageX], rollingPageY: [o.pageY] };
        let a = this._newGestureEvent(he.START, o.target);
        a.pageX = o.pageX, a.pageY = o.pageY, this._dispatchEvent(a);
      }
      this._dispatched && (e.preventDefault(), e.stopPropagation(), this._dispatched = false);
    }
    _handleTouchEnd(e, t) {
      let r = Date.now(), s = Object.keys(this._activeTouches).length;
      for (let o = 0, a = t.changedTouches.length; o < a; o++) {
        let l = t.changedTouches.item(o);
        if (!this._activeTouches.hasOwnProperty(String(l.identifier))) {
          console.warn("move of an UNKNOWN touch", l);
          continue;
        }
        let h = this._activeTouches[l.identifier], d = Date.now() - h.initialTimeStamp;
        if (d < K2._holdDelay && Math.abs(h.initialPageX - ce(h.rollingPageX)) < 30 && Math.abs(h.initialPageY - ce(h.rollingPageY)) < 30) {
          ...
          let c = ce(h.rollingPageX), u = ce(h.rollingPageY), _ = ce(h.rollingTimestamps) - h.rollingTimestamps[0], p = c - h.rollingPageX[0], v = u - h.rollingPageY[0], f = [...this._targets].filter((S) => h.initialTarget instanceof Node && S.contains(h.initialTarget));
          this._inertia(e, f, r, Math.abs(p) / _, p > 0 ? 1 : -1, c, Math.abs(v) / _, v > 0 ? 1 : -1, u);
        }
        this._dispatchEvent(this._newGestureEvent(he.END, h.initialTarget)), delete this._activeTouches[l.identifier];
      }
    ...
    _dispatchEvent(e) {
      ...
      if (e.initialTarget instanceof Node) {
        ...
        for (let r of this._targets) if (r.contains(e.initialTarget)) {
          let s = 0, o = e.initialTarget;
          for (; o && o !== r; ) s++, o = o.parentElement;
          t.push([s, r]);
        }
        t.sort((r, s) => r[0] - s[0]);
    ...
    _inertia(e, t, r, s, o, a, l, h, d) {
      this._handle = tt(e, () => {
        let c = Date.now(), u = c - r, _ = 0, p = 0, v = true;
        s += K2._scrollFriction * u, l += K2._scrollFriction * u, s > 0 && (v = false, _ = o * s * u), l > 0 && (v = false, p = h * l * u);
        let f = this._newGestureEvent(he.CHANGE);
        f.translationX = _, f.translationY = p, t.forEach((S) => S.dispatchEvent(f)), v || this._inertia(e, t, c, s, o, a + _, l, h, d + p);
      });
    }
    _handleTouchMove(e) {
      let t = Date.now();
      for (let r = 0, s = e.changedTouches.length; r < s; r++) {
        ...
        if (!this._activeTouches.hasOwnProperty(String(o.identifier))) {
          console.warn("end of an UNKNOWN touch", o);
          continue;
        }
        let a = this._activeTouches[o.identifier], l = this._newGestureEvent(he.CHANGE, a.initialTarget);
        l.translationX = o.pageX - ce(a.rollingPageX), l.translationY = o.pageY - ce(a.rollingPageY), l.pageX = o.pageX, l.pageY = o.pageY, l.clientX = o.clientX, l.clientY = o.clientY, this._dispatchEvent(l), a.rollingPageX.length > 3 && (a.rollingPageX.shift(), a.rollingPageY.shift(), a.rollingTimestamps.shift()), a.rollingPageX.push(o.pageX), a.rollingPageY.push(o.pageY), a.rollingTimestamps.push(t);
      }
      this._dispatched && (e.preventDefault(), e.stopPropagation(), this._dispatched = false);
    }
  };
  ...
  var gt = class {
    ...
    bindMouse(i, e, t) {
      let { element: r, document: s } = i, o = { mouseup: null, wheel: null, mousedrag: null, mousemove: null }, a = new P(), l = new P();
      e(a), e(l);
      let h = { target: i, focus: t, requestedEvents: o, mouseupListener: a, mousedragListener: l }, d = { mouseup: (c) => this._handleMouseUp(h, c), wheel: (c) => this._handleWheel(h, c), mousedrag: (c) => this._handleMouseDrag(h, c), mousemove: (c) => this._handleMouseMove(h, c) };
      this._altMouseCursor = new cs(r, s, () => this._mouseStateService.areMouseEventsActive && !!this._optionsService.rawOptions.mouseEventsRequireAlt), e(this._altMouseCursor), e(this._mouseStateService.onProtocolChange((c) => {
        this._handleProtocolChange(h, d, c);
      })), e(this._optionsService.onSpecificOptionChange("mouseEventsRequireAlt", () => {
        this._syncMouseModeState(r), this._altMouseCursor?.sync();
      })), this._mouseStateService.activeProtocol = this._mouseStateService.activeProtocol, e(C(r, "mousedown", (c) => this._handleMouseDown(h, c))), e(C(r, "wheel", (c) => this._handlePassiveWheel(h, c), { passive: false })), e(Vi.addTarget(i.screenElement)), e(C(i.screenElement, he.START, () => this._handleTouchStart())), e(C(i.screenElement, he.CHANGE, (c) => this._handleTouchChange(h, c)));
    }
    _sendEvent(i, e) {
      ...
      switch (e.overrideType || e.type) {
        case "mousemove":
          s = 32, e.buttons === void 0 ? (r = 3, e.button !== void 0 && (r = e.button < 3 ? e.button : 3)) : r = e.buttons & 1 ? 0 : e.buttons & 4 ? 1 : e.buttons & 2 ? 2 : 3;
          break;
        case "mouseup":
          s = 0, r = e.button < 3 ? e.button : 3;
          break;
        case "mousedown":
          s = 1, r = e.button < 3 ? e.button : 3;
          break;
        case "wheel":
      ...
      if (s === void 0 || r === void 0 || r > 4 || r !== 4 && this._optionsService.rawOptions.mouseEventsRequireAlt && this._mouseStateService.areMouseEventsActive && !e.altKey) return false;
      let o = r !== 4 && this._optionsService.rawOptions.mouseEventsRequireAlt && this._mouseStateService.areMouseEventsActive;
      return this._triggerMouseEvent({ col: t.col, row: t.row, x: t.x, y: t.y, button: r, action: s, ctrl: e.ctrlKey, alt: o ? false : e.altKey, shift: e.shiftKey });
    }
    _handleMouseUp(i, e) {
      this._sendEvent(i, e), e.buttons || (i.mouseupListener.clear(), i.mousedragListener.clear());
    }
    _handleWheel(i, e) {
    ...
    _handleMouseDown(i, e) {
      if (e.preventDefault(), i.focus(), !this._mouseStateService.areMouseEventsActive || this._selectionService.shouldForceSelection(e)) return;
      this._sendEvent(i, e);
      let { element: t, document: r } = i.target, s = t.ownerDocument ?? r;
      i.requestedEvents.mouseup && (i.mouseupListener.value = C(s, "mouseup", i.requestedEvents.mouseup)), i.requestedEvents.mousedrag && (i.mousedragListener.value = C(s, "mousemove", i.requestedEvents.mousedrag));
    }
    _handlePassiveWheel(i, e) {
      if (!i.requestedEvents.wheel) {
        ...
        if (!this._bufferService.buffer.hasScrollback) {
          ...
          let s = "\x1B" + (this._coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (e.deltaY < 0 ? "A" : "B");
          return this._coreService.triggerDataEvent(s, true), e.preventDefault(), e.stopPropagation(), false;
        }
      }
    }
    _handleTouchStart() {
    ...
    _handleTouchScrollAsKeys(i) {
      ...
      for (let s = 0; s < Math.abs(t); s++) this._coreService.triggerDataEvent(r, true);
    }
    _handleTouchScrollAsWheel(i, e) {
      ...
      let s = this._mouseCoordsService.getMouseReportCoords(e, i.target.screenElement);
      if (s) for (let o = 0; o < Math.abs(r); o++) this._triggerMouseEvent({ col: s.col, row: s.row, x: s.x, y: s.y, button: 4, action: r < 0 ? 0 : 1, ctrl: false, alt: false, shift: false });
    }
    reset() {
    ...
    _consumeWheelEvent(i, e, t) {
      ...
      let r = e / t, s = this._applyScrollModifier(i.deltaY, i);
      return i.deltaMode === WheelEvent.DOM_DELTA_PIXEL ? (s /= r + 0, Math.abs(i.deltaY) < 50 && (s *= 0.3), this._wheelPartialScroll += s, s = Math.floor(Math.abs(this._wheelPartialScroll)) * (this._wheelPartialScroll > 0 ? 1 : -1), this._wheelPartialScroll %= 1) : i.deltaMode === WheelEvent.DOM_DELTA_PAGE && (s *= this._bufferService.rows), s;
    }
  ...
  var qi = class {
    ...
    _process(i) {
      ...
      let e, t = 0, r = i.timeRemaining(), s;
      for (; this._i < this._tasks.length; ) {
        if (e = performance.now(), this._tasks[this._i]() || this._i++, e = Math.max(1, performance.now() - e), t = Math.max(e, t), s = i.timeRemaining(), t * 1.5 > s) {
  ...
  var Ct = class extends g {
    constructor(e, t, r, s, o, a, l, h, d, c) {
      super();
      this._rowCount = e;
      this._optionsService = r;
      this._logService = s;
    ...
    _registerIntersectionObserver(e, t) {
      if ("IntersectionObserver" in e) {
        let r = new e.IntersectionObserver((s) => this._handleIntersectionChange(s[s.length - 1]), { threshold: 0 });
    ...
    refreshRows(e, t, r = false, s = false) {
      if (this._isPaused) {
      ...
      let o = this._syncOutputHandler.flush();
      o && (e = Math.min(e, o.start), t = Math.max(t, o.end)), s || (this._isNextRenderRedrawOnly = false), r ? this._renderRows(e, t) : this._renderDebouncer.refresh(e, t, this._rowCount);
    }
    _renderRows(e, t) {
  ...
  function tn(n10, i, e, t) {
    let r = e.buffer.x, s = e.buffer.y;
    if (!e.buffer.hasScrollback) return ro(r, s, n10, i, e, t) + Yi(s, i, e, t) + so(r, s, n10, i, e, t);
    let o;
    if (s === i) return o = r > n10 ? "D" : "C", Yt(Math.abs(r - n10), Xt(o, t));
    o = s > i ? "D" : "C";
    let a = Math.abs(s - i), l = io(s > i ? n10 : r, e) + (a - 1) * e.cols + 1 + to(s > i ? r : n10, e);
    return Yt(l, Xt(o, t));
  }
  function to(n10, i) {
    return n10 - 1;
  ...
  function ro(n10, i, e, t, r, s) {
    return Yi(i, t, r, s).length === 0 ? "" : Yt(sn(n10, i, n10, i - $e(i, r), false, r).length, Xt("D", s));
  }
  function Yi(n10, i, e, t) {
    let r = n10 - $e(n10, e), s = i - $e(i, e), o = Math.abs(r - s) - no(n10, i, e);
    return Yt(o, Xt(rn(n10, i), t));
  }
  function so(n10, i, e, t, r, s) {
    let o;
    Yi(i, t, r, s).length > 0 ? o = t - $e(t, r) : o = i;
    let a = t, l = oo(n10, i, e, t, r, s);
    return Yt(sn(n10, o, e, a, l === "C", r).length, Xt(l, s));
  }
  function no(n10, i, e) {
    let t = 0, r = n10 - $e(n10, e), s = i - $e(i, e);
    for (let o = 0; o < Math.abs(r - s); o++) {
      let a = rn(n10, i) === "A" ? -1 : 1;
      e.buffer.lines.get(r + a * o)?.isWrapped && t++;
    }
    return t;
  }
  function $e(n10, i) {
  ...
  function oo(n10, i, e, t, r, s) {
    let o;
    return Yi(i, t, r, s).length > 0 ? o = t - $e(t, r) : o = i, n10 < e && o <= t || n10 >= e && o < t ? "C" : "D";
  }
  function rn(n10, i) {
    return n10 > i ? "A" : "B";
  }
  function sn(n10, i, e, t, r, s) {
    let o = n10, a = i, l = "";
    for (; (o !== e || a !== t) && a >= 0 && a < s.buffer.lines.length; ) o += r ? 1 : -1, r && o > s.cols - 1 ? (l += s.buffer.translateBufferLineToString(a, false, n10, o), o = 0, n10 = 0, a++) : !r && o < 0 && (l += s.buffer.translateBufferLineToString(a, false, 0, n10 + 1), o = s.cols - 1, n10 = o, a--);
    return l + s.buffer.translateBufferLineToString(a, false, n10, o);
  }
  function Xt(n10, i) {
    let e = i ? "O" : "[";
    return "\x1B" + e + n10;
  ...
  var Et = class extends g {
    ...
    get selectionText() {
      let e = this._model.finalSelectionStart, t = this._model.finalSelectionEnd;
      if (!e || !t) return "";
      let r = this._bufferService.buffer, s = [];
      if (this._activeSelectionMode === 3) {
        if (e[0] === t[0]) return "";
        let a = e[0] < t[0] ? e[0] : t[0], l = e[0] < t[0] ? t[0] : e[0];
        for (let h = e[1]; h <= t[1]; h++) {
          let d = r.translateBufferLineToString(h, true, a, l);
          s.push(d);
        }
      } else {
        let a = e[1] === t[1] ? t[0] : void 0;
        s.push(r.translateBufferLineToString(e[1], true, e[0], a));
        for (let l = e[1] + 1; l <= t[1] - 1; l++) {
          let h = r.lines.get(l), d = r.translateBufferLineToString(l, true);
          h?.isWrapped ? s[s.length - 1] += d : s.push(d);
        }
        if (e[1] !== t[1]) {
          let l = r.lines.get(t[1]), h = r.translateBufferLineToString(t[1], true, 0, t[0]);
          l && l.isWrapped ? s[s.length - 1] += h : s.push(h);
        }
      }
      return s.map((a) => a.replace(lo, " ")).join(Ue ? `\r
` : `
`);
    }
    clearSelection() {
    ...
    _isClickInSelection(e) {
      let t = this._getMouseBufferCoords(e), r = this._model.finalSelectionStart, s = this._model.finalSelectionEnd;
      return !r || !s || !t ? false : this._areCoordsInSelection(t, r, s);
    }
    isCellInSelection(e, t) {
      let r = this._model.finalSelectionStart, s = this._model.finalSelectionEnd;
      return !r || !s ? false : this._areCoordsInSelection([e, t], r, s);
    }
    ...
    _selectWordAtCursor(e, t) {
      ...
      return s ? (this._selectWordAt(s, t), this._model.selectionEnd = void 0, true) : false;
    }
    selectAll() {
    ...
    _handleMouseMove(e) {
      ...
      if (this._model.selectionEnd[1] < r.lines.length) {
        let s = r.lines.get(this._model.selectionEnd[1]);
      ...
      if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < 500 && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
        if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
          ...
          if (r && r[0] !== void 0 && r[1] !== void 0) {
            let s = tn(r[0] - 1, r[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
    ...
    _convertViewportColToCharacterIndex(e, t) {
      let r = t;
      for (let s = 0; t >= s; s++) {
        let o = e.loadCell(s, this._workCell).getChars().length;
        this._workCell.getWidth() === 0 ? r-- : o > 1 && t !== s && (r += o - 1);
      }
      return r;
    }
    setSelection(e, t, r) {
    ...
    _getWordAt(e, t, r = true, s = true) {
      if (e[0] >= this._bufferService.cols) return;
      let o = this._bufferService.buffer, a = o.lines.get(e[1]);
      if (!a) return;
      let l = o.translateBufferLineToString(e[1], false), h = this._convertViewportColToCharacterIndex(a, e[0]), d = h, c = e[0] - h, u = 0, _ = 0, p = 0, v = 0;
      if (l.charAt(h) === " ") {
        for (; h > 0 && l.charAt(h - 1) === " "; ) h--;
        for (; d < l.length && l.charAt(d + 1) === " "; ) d++;
      } else {
        let I = e[0], w = e[0];
        a.getWidth(I) === 0 && (u++, I--), a.getWidth(w) === 2 && (_++, w++);
        let L = a.getString(w).length;
        for (L > 1 && (v += L - 1, d += L - 1); I > 0 && h > 0 && !this._isCharWordSeparator(a.loadCell(I - 1, this._workCell)); ) {
          a.loadCell(I - 1, this._workCell);
          let T = this._workCell.getChars().length;
          this._workCell.getWidth() === 0 ? (u++, I--) : T > 1 && (p += T - 1, h -= T - 1), h--, I--;
        }
        for (; w < a.length && d + 1 < l.length && !this._isCharWordSeparator(a.loadCell(w + 1, this._workCell)); ) {
          a.loadCell(w + 1, this._workCell);
          let T = this._workCell.getChars().length;
          this._workCell.getWidth() === 2 ? (_++, w++) : T > 1 && (v += T - 1, d += T - 1), d++, w++;
        }
      }
      d++;
      let f = h + c - u + p, S = Math.min(this._bufferService.cols, d - h + u + _ - p - v);
      if (!(!t && l.slice(h, d).trim() === "")) {
        if (r && f === 0 && a.getCodePoint(0) !== 32) {
          let I = o.lines.get(e[1] - 1);
          if (I && a.isWrapped && I.getCodePoint(this._bufferService.cols - 1) !== 32) {
            let w = this._getWordAt([this._bufferService.cols - 1, e[1] - 1], false, true, false);
            if (w) {
              let L = this._bufferService.cols - w.start;
              f -= L, S += L;
            }
          }
        }
        if (s && f + S === this._bufferService.cols && a.getCodePoint(this._bufferService.cols - 1) !== 32) {
          let I = o.lines.get(e[1] + 1);
          if (I?.isWrapped && I.getCodePoint(0) !== 32) {
            let w = this._getWordAt([0, e[1] + 1], false, false, true);
            w && (S += w.length);
          }
        }
        return { start: f, length: S };
      }
    }
    _selectWordAt(e, t) {
  ...
  var $ = Object.freeze((() => {
    ...
    for (let e = 0; e < 216; e++) {
      let t = i[e / 36 % 6 | 0], r = i[e / 6 % 6 | 0], s = i[e % 6];
      n10.push({ css: O.toCss(t, r, s), rgba: O.toRgba(t, r, s) });
    }
    for (let e = 0; e < 24; e++) {
      let t = 8 + e * 10;
  ...
  var yt = class extends g {
    ...
    _setTheme(e = {}) {
      ...
      if (t.foreground = M(e.foreground, qe), t.background = M(e.background, Qt), t.cursor = k.blend(t.background, M(e.cursor, nn)), t.cursorAccent = k.blend(t.background, M(e.cursorAccent, on)), t.selectionBackgroundTransparent = M(e.selectionBackground, Jt), t.selectionBackgroundOpaque = k.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = M(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = k.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? M(e.selectionForeground, ts) : void 0, t.selectionForeground === ts && (t.selectionForeground = void 0), k.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = k.opacity(t.selectionBackgroundTransparent, 0.3)), k.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = k.opacity(t.selectionInactiveBackgroundTransparent, 0.3)), t.scrollbarSliderBackground = M(e.scrollbarSliderBackground, k.opacity(t.foreground, 0.2)), t.scrollbarSliderHoverBackground = M(e.scrollbarSliderHoverBackground, k.opacity(t.foreground, 0.4)), t.scrollbarSliderActiveBackground = M(e.scrollbarSliderActiveBackground, k.opacity(t.foreground, 0.5)), t.overviewRulerBorder = M(e.overviewRulerBorder, co), t.ansi = $.slice(), t.ansi[0] = M(e.black, $[0]), t.ansi[1] = M(e.red, $[1]), t.ansi[2] = M(e.green, $[2]), t.ansi[3] = M(e.yellow, $[3]), t.ansi[4] = M(e.blue, $[4]), t.ansi[5] = M(e.magenta, $[5]), t.ansi[6] = M(e.cyan, $[6]), t.ansi[7] = M(e.white, $[7]), t.ansi[8] = M(e.brightBlack, $[8]), t.ansi[9] = M(e.brightRed, $[9]), t.ansi[10] = M(e.brightGreen, $[10]), t.ansi[11] = M(e.brightYellow, $[11]), t.ansi[12] = M(e.brightBlue, $[12]), t.ansi[13] = M(e.brightMagenta, $[13]), t.ansi[14] = M(e.brightCyan, $[14]), t.ansi[15] = M(e.brightWhite, $[15]), e.extendedAnsi) {
        ...
        for (let s = 0; s < r; s++) t.ansi[s + 16] = M(e.extendedAnsi[s], $[s + 16]);
      }
  ...
  function ln(n10, i, e, t) {
    let r = { type: 0, cancel: false, key: void 0 }, s = (n10.shiftKey ? 1 : 0) | (n10.altKey ? 2 : 0) | (n10.ctrlKey ? 4 : 0) | (n10.metaKey ? 8 : 0);
    switch (n10.keyCode) {
      case 0:
      ...
      case 37:
        ...
        s ? r.key = "\x1B[1;" + (s + 1) + "D" : i ? r.key = "\x1BOD" : r.key = "\x1B[D";
        break;
      case 39:
        if (n10.metaKey) break;
        s ? r.key = "\x1B[1;" + (s + 1) + "C" : i ? r.key = "\x1BOC" : r.key = "\x1B[C";
        break;
      case 38:
        if (n10.metaKey) break;
        s ? r.key = "\x1B[1;" + (s + 1) + "A" : i ? r.key = "\x1BOA" : r.key = "\x1B[A";
        break;
      case 40:
        if (n10.metaKey) break;
        s ? r.key = "\x1B[1;" + (s + 1) + "B" : i ? r.key = "\x1BOB" : r.key = "\x1B[B";
        break;
      case 45:
        !n10.shiftKey && !n10.ctrlKey && (r.key = "\x1B[2~");
        break;
      case 46:
        s ? r.key = "\x1B[3;" + (s + 1) + "~" : r.key = "\x1B[3~";
        break;
      case 36:
        s ? r.key = "\x1B[1;" + (s + 1) + "H" : i ? r.key = "\x1BOH" : r.key = "\x1B[H";
        break;
      case 35:
        s ? r.key = "\x1B[1;" + (s + 1) + "F" : i ? r.key = "\x1BOF" : r.key = "\x1B[F";
        break;
      case 33:
        n10.shiftKey ? r.type = 2 : n10.ctrlKey ? r.key = "\x1B[5;" + (s + 1) + "~" : r.key = "\x1B[5~";
        break;
      case 34:
        n10.shiftKey ? r.type = 3 : n10.ctrlKey ? r.key = "\x1B[6;" + (s + 1) + "~" : r.key = "\x1B[6~";
        break;
      case 112:
        s ? r.key = "\x1B[1;" + (s + 1) + "P" : r.key = "\x1BOP";
        break;
      case 113:
        s ? r.key = "\x1B[1;" + (s + 1) + "Q" : r.key = "\x1BOQ";
        break;
      case 114:
        s ? r.key = "\x1B[1;" + (s + 1) + "R" : r.key = "\x1BOR";
        break;
      case 115:
        s ? r.key = "\x1B[1;" + (s + 1) + "S" : r.key = "\x1BOS";
        break;
      case 116:
        s ? r.key = "\x1B[15;" + (s + 1) + "~" : r.key = "\x1B[15~";
        break;
      case 117:
        s ? r.key = "\x1B[17;" + (s + 1) + "~" : r.key = "\x1B[17~";
        break;
      case 118:
        s ? r.key = "\x1B[18;" + (s + 1) + "~" : r.key = "\x1B[18~";
        break;
      case 119:
        s ? r.key = "\x1B[19;" + (s + 1) + "~" : r.key = "\x1B[19~";
        break;
      case 120:
        s ? r.key = "\x1B[20;" + (s + 1) + "~" : r.key = "\x1B[20~";
        break;
      case 121:
        s ? r.key = "\x1B[21;" + (s + 1) + "~" : r.key = "\x1B[21~";
        break;
      case 122:
        s ? r.key = "\x1B[23;" + (s + 1) + "~" : r.key = "\x1B[23~";
        break;
      case 123:
        s ? r.key = "\x1B[24;" + (s + 1) + "~" : r.key = "\x1B[24~";
        break;
      default:
        if (n10.ctrlKey && !n10.shiftKey && !n10.altKey && !n10.metaKey) n10.keyCode >= 65 && n10.keyCode <= 90 ? r.key = String.fromCharCode(n10.keyCode - 64) : n10.keyCode === 32 ? r.key = "\0" : n10.keyCode >= 51 && n10.keyCode <= 55 ? r.key = String.fromCharCode(n10.keyCode - 51 + 27) : n10.keyCode === 56 ? r.key = "\x7F" : n10.key === "/" ? r.key = "" : n10.keyCode === 219 ? r.key = "\x1B" : n10.keyCode === 220 ? r.key = "" : n10.keyCode === 221 && (r.key = "");
          ...
          if (a) r.key = "\x1B" + a;
            ...
            let l = n10.ctrlKey ? n10.keyCode - 64 : n10.keyCode + 32, h = String.fromCharCode(l);
            ...
            let l = n10.code.slice(3, 4);
            n10.shiftKey || (l = l.toLowerCase()), r.key = "\x1B" + l, r.cancel = true;
          }
  ...
  var ei = class {
    ...
    _buildCsiTildeSequence(i, e, t, r) {
      let s = r && t !== 1, o = "\x1B[" + i;
      return (e > 0 || s) && (o += ";" + (e > 0 ? e : "1"), s && (o += ":" + t)), o += "~", o;
    }
    _buildCsiUSequence(i, e, t, r, s, o, a) {
      let l = !!(s & 2), h = !!(s & 4), d = "\x1B[" + e, c;
      h && i.shiftKey && i.key.length === 1 && !o && !a && (c = i.key.codePointAt(0), d += ":" + c);
      let _ = !!(s & 16) && r !== 3 && i.key.length === 1 && !o && !a && !i.ctrlKey ? i.key.codePointAt(0) : void 0, p = l && r !== 1 && (r === 3 || _ === void 0);
      return (t > 0 || p || _ !== void 0) && (d += ";", t > 0 ? d += t : p && (d += "1"), p && (d += ":" + r)), _ !== void 0 && (d += ";" + _), d += "u", d;
    }
    evaluate(i, e, t = 1, r = false) {
      let s = { type: 0, cancel: false, key: void 0 }, o = this._encodeModifiers(i), a = this._isModifierKey(i), l = !!(e & 2);
      if (!l && t === 3 || a && !(e & 8) || this._isLockKey(i) && !(e & 8)) return s;
      let h = this._csiLetterKeys[i.key];
      if (h) return s.key = this._buildCsiLetterSequence(h, o, t, l), s.cancel = true, s;
      let d = this._ss3FunctionKeys[i.key];
      if (d) return s.key = this._buildSs3Sequence(d, o, t, l), s.cancel = true, s;
      let c = this._csiTildeKeys[i.key];
      if (c !== void 0) return s.key = this._buildCsiTildeSequence(c, o, t, l), s.cancel = true, s;
      let u = this._getKeyCode(i, r);
      if (u === void 0) return s;
      let _ = u === 13 || u === 9 || u === 127;
      if (_ && t === 3 && !(e & 8)) return s;
      let p = this._functionalKeyCodes[i.key] !== void 0 || this._getNumpadKeyCode(i) !== void 0;
      if (!!(e & 8 || l && t === 3 || (e & 1 || l) && (p && !_ || o > 0 && i.key.length !== 1 || o - 1 > 1))) s.key = this._buildCsiUSequence(i, u, o, t, e, p, a), s.cancel = true;
      else {
        let f = u === 13 ? "\r" : u === 9 ? "	" : u === 127 ? "\x7F" : void 0;
        f ? s.key = f : i.key.length === 1 && !i.ctrlKey && !i.altKey && !i.metaKey && (s.key = i.key);
      }
      return s;
    }
  ...
  var Zi = class {
    ...
    evaluateKeyboardEvent(i, e) {
      let t = this._getVirtualKeyCode(i), r = this._getScanCode(i), s = this._getUnicodeChar(i), o = e ? 1 : 0, a = this._getControlKeyState(i);
      return { type: 0, cancel: true, key: `\x1B[${t};${r};${s};${o};${a};1_` };
    }
  };
  var xt = class {
    constructor(i, e) {
  ...
  var Ji = class {
    ...
    createInstance(i, ...e) {
      let t = Hs(i).sort((o, a) => o.index - a.index), r = [];
      for (let o of t) {
        let a = this._services.get(o.id);
        if (!a) throw new Error(`[createInstance] ${i.name} depends on UNKNOWN service ${o.id._id}.`);
        r.push(a);
      }
      let s = t.length > 0 ? t[0].index : e.length;
      if (e.length !== s) throw new Error(`[createInstance] First service dependency of ${i.name} at position ${s + 1} conflicts with ${e.length} static arguments`);
      return new i(...e, ...r);
    }
  };
  ...
  var ti = class extends g {
    ...
    splice(e, t, ...r) {
      ...
      for (let s = this._length - 1; s >= e; s--) this._array[this._getCyclicIndex(s + r.length)] = this._array[this._getCyclicIndex(s)];
      for (let s = 0; s < r.length; s++) this._array[this._getCyclicIndex(e + s)] = r[s];
      if (r.length && this.onInsertEmitter.fire({ index: e, amount: r.length }), this._length + r.length > this._maxLength) {
        let s = this._length + r.length - this._maxLength;
    ...
    shiftElements(e, t, r) {
      if (!(t <= 0)) {
        ...
        if (r > 0) {
          for (let o = t - 1; o >= 0; o--) this.set(e + o + r, this.get(e + o));
          let s = e + t + r - this._length;
          if (s > 0) for (this._length += s; this._length > this._maxLength; ) this._length--, this._startIndex++, this.onTrimEmitter.fire(1);
        } else for (let s = 0; s < t; s++) this.set(e + s + r, this.get(e + s));
      }
    }
    _getCyclicIndex(e) {
  ...
  var De = class n7 {
    ...
    copyCellsFrom(i, e, t, r, s) {
      this._invalidateStringCache();
      let o = i._data;
      if (s) for (let a = r - 1; a >= 0; a--) {
        for (let l = 0; l < 3; l++) this._data[(t + a) * 3 + l] = o[(e + a) * 3 + l];
    ...
    translateToString(i, e, t, r) {
      let s = (e === void 0 || e === 0) && t === void 0 && r === void 0;
      s && this._stringCache.touch?.();
      let o = s ? this._getStringCacheEntry(false) : void 0;
      if (s && o?.value !== void 0) {
        if (i) return o.isTrimmed ? o.value : o.value.trimEnd();
        if (!o.isTrimmed) return o.value;
      }
      for (e = e ?? 0, t = t ?? this.length, i && (t = Math.min(t, this.getTrimmedLength())), r && (r.length = 0), er.reset(); e < t; ) {
        let l = this._data[e * 3 + 0], h = l & 2097151, d = l & 2097152 ? this._combined[e] : h ? be(h) : " ";
      ...
      let a = er.toString();
      if (er.reset(), s) {
        let l = this._getStringCacheEntry(true);
        l.value = a, l.isTrimmed = !!i;
      }
      return a;
    }
  ...
  function dn(n10, i, e, t, r, s) {
    let o = [];
    for (let a = 0; a < n10.length - 1; a++) {
      let l = a, h = n10.get(++l);
      if (!h.isWrapped) continue;
      let d = [n10.get(a)];
      for (; l < n10.length && h.isWrapped; ) d.push(h), h = n10.get(++l);
      if (!s && t >= a && t < l) {
        a += d.length - 1;
        continue;
      }
      ...
      for (; _ < d.length; ) {
        let f = Tt(d, _, i), S = f - p, I = e - u, w = Math.min(S, I);
        d[c].copyCellsFrom(d[_], p, u, w, false), u += w, u === e && (c++, u = 0), p += w, p === f && (_++, p = 0), u === 0 && c !== 0 && d[c - 1].getWidth(e - 1) === 2 && (d[c].copyCellsFrom(d[c - 1], e - 1, u++, 1, false), d[c - 1].setCell(e - 1, r));
      }
      d[c].replaceCells(u, e, r);
      let v = 0;
      for (let f = d.length - 1; f > 0 && (f > c || d[f].getTrimmedLength() === 0); f--) v++;
      v > 0 && (o.push(a + d.length - v), o.push(v)), a += d.length - 1;
    }
    return o;
  }
  function un(n10, i) {
    let e = [], t = 0, r = i[t], s = 0;
    for (let o = 0; o < n10.length; o++) if (r === o) {
      let a = i[++t];
      n10.onDeleteEmitter.fire({ index: o - s, amount: a }), o += a - 1, s += a, r = i[++t];
    } else e.push(o);
  ...
  function _n(n10, i, e) {
    let t = [], r = 0;
    for (let l = 0; l < n10.length; l++) r += Tt(n10, l, i);
    let s = 0, o = 0, a = 0;
    for (; a < r; ) {
      if (r - a < e) {
        t.push(r - a);
  ...
  var si = class extends g {
    ...
    resize(e, t) {
      ...
      let s = 0, o = this._getCorrectBufferLength(t);
      if (o > this.lines.maxLength && (this.lines.maxLength = o), this.lines.length > 0) {
        if (this._cols < e) for (let l = 0; l < this.lines.length; l++) s += +this.lines.get(l).resize(e, r);
        let a = 0;
        ...
        if (o < this.lines.maxLength) {
          let l = this.lines.length - o;
          l > 0 && (this.lines.trimStart(l), this.ybase = Math.max(this.ybase - l, 0), this.ydisp = Math.max(this.ydisp - l, 0), this.savedY = Math.max(this.savedY - l, 0)), this.lines.maxLength = o;
        }
        this.x = Math.min(this.x, e - 1), this.y = Math.min(this.y, t - 1), a && (this.y += a), this.savedX = Math.min(this.savedX, e - 1), this.scrollTop = 0;
      }
      if (this.scrollBottom = t - 1, this._isReflowEnabled && (this._reflow(e, t), this._cols > e)) for (let a = 0; a < this.lines.length; a++) s += +this.lines.get(a).resize(e, r);
      if (this._cols = e, this._rows = t, this.lines.length > 0) {
        let a = Math.max(0, this.lines.length - this.ybase - 1);
        this.y = Math.min(this.y, a);
      }
      this._memoryCleanupQueue.clear(), s > 0.1 * this.lines.length && (this._memoryCleanupPosition = 0, this._memoryCleanupQueue.enqueue(() => this._batchedMemoryCleanup()));
    }
    ...
    _reflowLarger(e, t) {
      let r = this._optionsService.rawOptions.reflowCursorLine, s = dn(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(U), r);
      if (s.length > 0) {
        let o = un(this.lines, s);
        fn(this.lines, o.layout), this._reflowLargerAdjustViewport(e, t, o.countRemoved);
      }
    }
    _reflowLargerAdjustViewport(e, t, r) {
      let s = this.getNullCell(U), o = r;
      for (; o-- > 0; ) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new De(this._stringCache, e, s, false))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
      this.savedY = Math.max(this.savedY - r, 0);
    }
    _reflowSmaller(e, t) {
      let r = this._optionsService.rawOptions.reflowCursorLine, s = this.getNullCell(U), o = [], a = 0;
      for (let l = this.lines.length - 1; l >= 0; l--) {
        let h = this.lines.get(l);
        if (!h || !h.isWrapped && h.getTrimmedLength() <= e) continue;
        let d = [h];
        for (; h.isWrapped && l > 0; ) h = this.lines.get(--l), d.unshift(h);
        if (!r) {
          let T = this.ybase + this.y;
          if (T >= l && T < l + d.length) continue;
        }
        ...
        let v = [];
        for (let T = 0; T < _; T++) {
          let te = this.getBlankLine(U, true);
          v.push(te);
        }
        v.length > 0 && (o.push({ start: l + d.length + a, newLines: v }), a += v.length), d.push(...v);
        let f = u.length - 1, S = u[f];
        S === 0 && (f--, S = u[f]);
        let I = d.length - _ - 1, w = c;
        for (; I >= 0; ) {
          let T = Math.min(w, S);
          if (d[f] === void 0) break;
          if (d[f].copyCellsFrom(d[I], w - T, S - T, T, true), S -= T, S === 0 && (f--, S = u[f]), w -= T, w === 0) {
            I--;
            let te = Math.max(I, 0);
            w = Tt(d, te, this._cols);
          }
        }
        for (let T = 0; T < d.length; T++) u[T] < e && d[T].setCell(u[T], s);
        let L = _ - p;
      ...
      if (o.length > 0) {
        ...
        let d = this.lines.length, c = d - 1, u = 0, _ = o[u];
        ...
        for (let S = Math.min(this.lines.maxLength - 1, d + a - 1); S >= 0; S--) if (_ && _.start > c + p) {
          ...
          S++, l.push({ index: c + 1, amount: _.newLines.length }), p += _.newLines.length, _ = o[++u];
        } else this.lines.set(S, h[c--]);
        let v = 0;
        for (let S = l.length - 1; S >= 0; S--) l[S].index += v, this.lines.onInsertEmitter.fire(l[S]), v += l[S].amount;
        let f = Math.max(0, d + a - this.lines.maxLength);
        f > 0 && this.lines.onTrimEmitter.fire(f);
      }
    }
    translateBufferLineToString(e, t, r = 0, s) {
      let o = this.lines.get(e);
      return o ? o.translateToString(t, r, s) : "";
    }
  ...
  var Dt = class extends g {
    ...
    resize(e, t) {
      let r = this.cols !== e, s = this.rows !== t;
      this.cols = e, this.rows = t, this.buffers.resize(e, t), this._onResize.fire({ cols: e, rows: t, colsChanged: r, rowsChanged: s });
    }
    reset() {
    ...
    scroll(e, t = false) {
      let r = this.buffer, s;
      s = this._cachedBlankLine, (!s || s.length !== this.cols || s.getFg(0) !== e.fg || s.getBg(0) !== e.bg) && (s = r.getBlankLine(e, t), this._cachedBlankLine = s), s.isWrapped = t;
      let o = r.ybase + r.scrollTop, a = r.ybase + r.scrollBottom;
      if (r.scrollTop === 0) {
        let l = r.lines.isFull;
        a === r.lines.length - 1 ? l ? r.lines.recycle().copyFrom(s) : r.lines.push(s.clone()) : r.lines.splice(a + 1, 0, s.clone()), l ? this.isUserScrolling && (r.ydisp = Math.max(r.ydisp - 1, 0)) : (r.ybase++, this.isUserScrolling || r.ydisp++);
      } else {
        let l = a - o + 1;
        r.lines.shiftElements(o + 1, l - 1, -1), r.lines.set(a, s.clone());
      }
  ...
  var nr = class extends g {
    constructor(e) {
      ...
      for (let r in e) if (r in t) try {
        let s = e[r];
        t[r] = this._sanitizeAndValidateOption(r, s);
      } catch (s) {
        console.error(s);
      }
    ...
    _setupOptions() {
      ...
      for (let r in this.rawOptions) {
        let s = { get: e.bind(this, r), set: t.bind(this, r) };
  ...
  var Lt = class extends g {
    ...
    triggerDataEvent(e, t = false) {
      ...
      let r = this._bufferService.buffer;
      t && this._optionsService.rawOptions.scrollOnUserInput && r.ybase !== r.ydisp && this._onRequestScrollToBottom.fire(), t && this._onUserInput.fire(), this._logService.debug(`sending data "${e}"`), this._logService.trace("sending data (codes)", () => e.split("").map((s) => s.charCodeAt(0))), this._onData.fire(e);
    }
  ...
  var me = class n8 {
    ...
    getStringCellWidth(i) {
      ...
      for (let s = 0; s < r; ++s) {
        let o = i.charCodeAt(s);
        if (55296 <= o && o <= 56319) {
          if (++s >= r) return e + this.wcwidth(o);
          let h = i.charCodeAt(s);
          56320 <= h && h <= 57343 ? o = (o - 55296) * 1024 + h - 56320 + 65536 : e += this.wcwidth(h);
        }
        let a = this.charProperties(o, t), l = n8.extractWidth(a);
        n8.extractShouldJoin(a) && (l -= n8.extractWidth(t)), e += l, t = a;
      }
      return e;
    }
    charProperties(i, e) {
  ...
  var At = class n9 {
    ...
    static fromArray(i) {
      ...
      for (let t = Array.isArray(i[0]) ? 1 : 0; t < i.length; ++t) {
        let r = i[t];
        if (Array.isArray(r)) for (let s = 0; s < r.length; ++s) e.addSubParam(r[s]);
        else e.addParam(r);
      }
      return e;
    }
    ...
    put(i, e, t) {
      ...
      if (this._state !== 0) {
        if (this._state !== 3) if (this._state === 1 && this._start(), !this._active.length) this._handlerFb(this._id, "END", i);
          ...
          let t = false, r = this._active.length - 1, s = false;
          if (this._stack.paused && (r = this._stack.loopPosition - 1, t = e, s = this._stack.fallThrough, this._stack.paused = false), !s && t === false) {
  ...
  var Cs = class {
    ...
    addMany(i, e, t, r) {
      for (let s = 0; s < i.length; s++) this.table[e << 8 | i[s]] = t << 8 | r;
    }
  };
  var oe = 160;
  var So = (function() {
    let n10 = new Cs(4257), e = Array.apply(null, Array(256)).map((a, l) => l), t = (a, l) => e.slice(a, l), r = t(32, 127), s = t(0, 24);
    s.push(25), s.push.apply(s, t(28, 32));
    let o = t(0, 17);
    n10.setDefault(1, 0), n10.addMany(r, 0, 2, 0);
    for (let a of o) n10.addMany([24, 26, 153, 154], a, 3, 0), n10.addMany(t(128, 144), a, 3, 0), n10.addMany(t(144, 152), a, 3, 0), n10.add(156, a, 0, 0), n10.add(27, a, 11, 1), n10.add(157, a, 4, 8), n10.addMany([152, 158], a, 0, 7), n10.add(159, a, 11, 14), n10.add(155, a, 11, 3), n10.add(144, a, 11, 9);
    return n10.addMany(s, 0, 3, 0), n10.addMany(s, 1, 3, 1), n10.add(127, 1, 0, 1), n10.addMany(s, 8, 0, 8), n10.addMany(s, 3, 3, 3), n10.add(127, 3, 0, 3), n10.addMany(s, 4, 3, 4), n10.add(127, 4, 0, 4), n10.addMany(s, 6, 3, 6), n10.addMany(s, 5, 3, 5), n10.add(127, 5, 0, 5), n10.addMany(s, 2, 3, 2), n10.add(127, 2, 0, 2), n10.add(93, 1, 4, 8), n10.addMany(r, 8, 5, 8), n10.add(127, 8, 5, 8), n10.addMany([156, 27, 24, 26, 7], 8, 6, 0), n10.addMany(t(28, 32), 8, 0, 8), n10.addMany([88, 94], 1, 0, 7), n10.addMany(r, 7, 0, 7), n10.addMany(s, 7, 0, 7), n10.add(156, 7, 0, 0), n10.add(127, 7, 0, 7), n10.add(95, 1, 11, 14), n10.addMany(s, 14, 0, 14), n10.add(127, 14, 0, 14), n10.addMany(t(32, 48), 14, 9, 15), n10.addMany(t(48, 127), 14, 15, 16), n10.addMany(t(48, 127), 15, 15, 16), n10.addMany(s, 15, 0, 15), n10.addMany(t(32, 48), 15, 9, 15), n10.add(127, 15, 0, 15), n10.addMany(r, 16, 16, 16), n10.addMany(s, 16, 0, 16), n10.addMany(t(8, 14), 16, 16, 16), n10.add(127, 16, 0, 16), n10.addMany([27, 156, 24, 26], 16, 17, 0), n10.add(91, 1, 11, 3), n10.addMany(t(64, 127), 3, 7, 0), n10.addMany(t(48, 60), 3, 8, 4), n10.addMany([60, 61, 62, 63], 3, 9, 4), n10.addMany(t(48, 60), 4, 8, 4), n10.addMany(t(64, 127), 4, 7, 0), n10.addMany([60, 61, 62, 63], 4, 0, 6), n10.addMany(t(32, 64), 6, 0, 6), n10.add(127, 6, 0, 6), n10.addMany(t(64, 127), 6, 0, 0), n10.addMany(t(32, 48), 3, 9, 5), n10.addMany(t(32, 48), 5, 9, 5), n10.addMany(t(48, 64), 5, 0, 6), n10.addMany(t(64, 127), 5, 7, 0), n10.addMany(t(32, 48), 4, 9, 5), n10.addMany(t(32, 48), 1, 9, 2), n10.addMany(t(32, 48), 2, 9, 2), n10.addMany(t(48, 127), 2, 10, 0), n10.addMany(t(48, 80), 1, 10, 0), n10.addMany(t(81, 88), 1, 10, 0), n10.addMany([89, 90, 92], 1, 10, 0), n10.addMany(t(96, 127), 1, 10, 0), n10.add(80, 1, 11, 9), n10.addMany(s, 9, 0, 9), n10.add(127, 9, 0, 9), n10.addMany(t(32, 48), 9, 9, 12), n10.addMany(t(48, 60), 9, 8, 10), n10.addMany([60, 61, 62, 63], 9, 9, 10), n10.addMany(s, 11, 0, 11), n10.addMany(t(32, 128), 11, 0, 11), n10.addMany(s, 10, 0, 10), n10.add(127, 10, 0, 10), n10.addMany(t(48, 60), 10, 8, 10), n10.addMany([60, 61, 62, 63], 10, 0, 11), n10.addMany(t(32, 48), 10, 9, 12), n10.addMany(s, 12, 0, 12), n10.add(127, 12, 0, 12), n10.addMany(t(32, 48), 12, 9, 12), n10.addMany(t(48, 64), 12, 0, 11), n10.addMany(t(64, 127), 12, 12, 13), n10.addMany(t(64, 127), 10, 12, 13), n10.addMany(t(64, 127), 9, 12, 13), n10.addMany(s, 13, 13, 13), n10.addMany(r, 13, 13, 13), n10.add(127, 13, 0, 13), n10.addMany([27, 156, 24, 26], 13, 14, 0), n10.add(oe, 0, 2, 0), n10.add(oe, 8, 5, 8), n10.add(oe, 6, 0, 6), n10.add(oe, 11, 0, 11), n10.add(oe, 13, 13, 13), n10.add(oe, 16, 16, 16), n10;
  })();
  var mr = class extends g {
    constructor(e = So) {
      ...
      this.initialState = 0, this.currentState = this.initialState, this._params = new At(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (t, r, s) => {
    ...
    _identifier(e, t = [64, 126]) {
      ...
      if (e.intermediates) {
        ...
        for (let o = 0; o < e.intermediates.length; ++o) {
          let a = e.intermediates.charCodeAt(o);
    ...
    _preserveStack(e, t, r, s, o) {
      this._parseStack.state = e, this._parseStack.handlers = t, this._parseStack.handlerPos = r, this._parseStack.transition = s, this._parseStack.chunkPos = o;
    }
    parse(e, t, r) {
      let s, o, a = 0, l;
      if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, a = this._parseStack.chunkPos + 1;
        ...
        switch (this._parseStack.state) {
          case 3:
            if (r === false && d > -1) {
              for (; d >= 0 && (l = h[d](this._params), l !== true); d--) if (l instanceof Promise) return this._parseStack.handlerPos = d, l;
            }
            this._parseStack.handlers = [];
            break;
          case 4:
            if (r === false && d > -1) {
              for (; d >= 0 && (l = h[d](), l !== true); d--) if (l instanceof Promise) return this._parseStack.handlerPos = d, l;
            }
            this._parseStack.handlers = [];
            break;
          case 6:
            if (s = e[this._parseStack.chunkPos], l = this._dcsParser.unhook(s !== 24 && s !== 26, r), l) return l;
            s === 27 && (this._parseStack.transition |= 1), this._params.resetZdm(), this._collect = 0;
            break;
          case 5:
            if (s = e[this._parseStack.chunkPos], l = this._oscParser.end(s !== 24 && s !== 26, r), l) return l;
            s === 27 && (this._parseStack.transition |= 1), this._params.resetZdm(), this._collect = 0;
            break;
          case 7:
            if (s = e[this._parseStack.chunkPos], l = this._apcParser.end(s !== 24 && s !== 26, r), l) return l;
            s === 27 && (this._parseStack.transition |= 1), this._params.resetZdm(), this._collect = 0;
            break;
        }
      ...
      for (let h = a; h < t; ++h) {
        if (s = e[h], s < 24 && this.currentState <= 6) {
          (this._executeHandlersArr[s] ?? this._executeHandlerFb)(s), this.precedingJoinState = 0;
          continue;
        }
        if (s === 27 && this.currentState < 8 && h + 2 < t && e[h + 1] === 91) {
          ...
          for (; d < t; d++) if (c = e[d], c >= 48 && c <= 57) this._params.addDigit(c - 48);
            ...
            for (; p >= 0 && (l = _[p](this._params), l !== true); p--) if (l instanceof Promise) return o = 1792, this._preserveStack(3, _, p, o, d), l;
        ...
        switch (o = this._transitions.table[this.currentState << 8 | (s < oe ? s : oe)], o >> 8) {
          case 2:
            let d = h, c = t - 4;
          ...
          case 0:
            break;
          case 1:
            if (this._errorHandler({ position: h, code: s, currentState: this.currentState, collect: this._collect, params: this._params, abort: false }).abort) return;
            break;
          case 7:
            let _ = this._csiHandlers[this._collect << 8 | s], p = _ ? _.length - 1 : -1;
            for (; p >= 0 && (l = _[p](this._params), l !== true); p--) if (l instanceof Promise) return this._preserveStack(3, _, p, o, h), l;
            p < 0 && this._csiHandlerFb(this._collect << 8 | s, this._params), this.precedingJoinState = 0;
            break;
          case 8:
            do
              switch (s) {
          ...
          case 9:
            ...
            break;
          case 10:
            let v = this._escHandlers[this._collect << 8 | s], f = v ? v.length - 1 : -1;
            for (; f >= 0 && (l = v[f](), l !== true); f--) if (l instanceof Promise) return this._preserveStack(4, v, f, o, h), l;
            f < 0 && this._escHandlerFb(this._collect << 8 | s), this.precedingJoinState = 0;
            break;
          case 11:
            this._params.resetZdm(), this._collect = 0;
            break;
          case 12:
            ...
            break;
          case 13:
            for (let S = h + 1; ; ++S) if (S >= t || (s = e[S]) === 24 || s === 26 || s === 27 || s > 127 && s < oe) {
              this._dcsParser.put(e, h, S), h = S - 1;
              break;
            }
            break;
          case 14:
            if (l = this._dcsParser.unhook(s !== 24 && s !== 26), l) return this._preserveStack(6, [], 0, o, h), l;
            s === 27 && (o |= 1), this._params.resetZdm(), this._collect = 0, this.precedingJoinState = 0;
            break;
          case 4:
            this._oscParser.start();
            break;
          case 5:
            for (let S = h + 1; ; S++) if (S >= t || (s = e[S]) < 32 || s > 127 && s < oe) {
              this._oscParser.put(e, h, S), h = S - 1;
              break;
            }
            break;
          case 6:
            if (l = this._oscParser.end(s !== 24 && s !== 26), l) return this._preserveStack(5, [], 0, o, h), l;
            s === 27 && (o |= 1), this._params.resetZdm(), this._collect = 0, this.precedingJoinState = 0;
            break;
          case 15:
            this._apcParser.start(this._collect << 8 | s);
            break;
          case 16:
            ...
            break;
          case 17:
            if (l = this._apcParser.end(s !== 24 && s !== 26), l) return this._preserveStack(7, [], 0, o, h), l;
            s === 27 && (o |= 1), this._params.resetZdm(), this._collect = 0, this.precedingJoinState = 0;
            break;
        }
        this.currentState = o & 255;
      }
    }
  };
  ...
  function ys(n10) {
    ...
    if (i.startsWith("rgb:")) {
      ...
      for (let r = 0; r < 3; ++r) {
        let s = parseInt(i.slice(e * r, e * r + e), 16);
        t[r] = e === 1 ? s << 4 : e === 2 ? s : e === 3 ? s >> 4 : s >> 8;
      }
      return t;
    }
  }
  ...
  var br = class extends g {
    constructor(e, t, r, s, o, a, l, h, d = new mr()) {
      super();
      this._bufferService = e;
...
`, () => this.lineFeed()), this._parser.setExecuteHandler("\v", () => this.lineFeed()), this._parser.setExecuteHandler("\f", () => this.lineFeed()), this._parser.setExecuteHandler("\r", () => this.carriageReturn()), this._parser.setExecuteHandler("\b", () => this.backspace()), this._parser.setExecuteHandler("	", () => this.tab()), this._parser.setExecuteHandler("", () => this.shiftOut()), this._parser.setExecuteHandler("", () => this.shiftIn()), this._parser.setExecuteHandler("\x84", () => this.index()), this._parser.setExecuteHandler("\x85", () => this.nextLine()), this._parser.setExecuteHandler("\x88", () => this.tabSet()), this._parser.registerOscHandler(0, new ne((c) => (this.setTitle(c), this.setIconName(c), true))), this._parser.registerOscHandler(1, new ne((c) => this.setIconName(c))), this._parser.registerOscHandler(2, new ne((c) => this.setTitle(c))), this._parser.registerOscHandler(4, new ne((c) => this.setOrReportIndexedColor(c))), this._parser.registerOscHandler(8, new ne((c) => this.setHyperlink(c))), this._parser.registerOscHandler(10, new ne((c) => this.setOrReportFgColor(c))), this._parser.registerOscHandler(11, new ne((c) => this.setOrReportBgColor(c))), this._parser.registerOscHandler(12, new ne((c) => this.setOrReportCursorColor(c))), this._parser.registerOscHandler(104, new ne((c) => this.restoreIndexedColor(c))), this._parser.registerOscHandler(110, new ne((c) => this.restoreFgColor(c))), this._parser.registerOscHandler(111, new ne((c) => this.restoreBgColor(c))), this._parser.registerOscHandler(112, new ne((c) => this.restoreCursorColor(c))), this._parser.registerEscHandler({ final: "7" }, () => this.saveCursor()), this._parser.registerEscHandler({ final: "8" }, () => this.restoreCursor()), this._parser.registerEscHandler({ final: "D" }, () => this.index()), this._parser.registerEscHandler({ final: "E" }, () => this.nextLine()), this._parser.registerEscHandler({ final: "H" }, () => this.tabSet()), this._parser.registerEscHandler({ final: "M" }, () => this.reverseIndex()), this._parser.registerEscHandler({ final: "=" }, () => this.keypadApplicationMode()), this._parser.registerEscHandler({ final: ">" }, () => this.keypadNumericMode()), this._parser.registerEscHandler({ final: "c" }, () => this.fullReset()), this._parser.registerEscHandler({ final: "n" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "o" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "|" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "}" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "~" }, () => this.setgLevel(1)), this._parser.registerEscHandler({ intermediates: "%", final: "@" }, () => this.selectDefaultCharset()), this._parser.registerEscHandler({ intermediates: "%", final: "G" }, () => this.selectDefaultCharset());
    ...
    _preserveStack(e, t, r, s) {
      this._parseStack.paused = true, this._parseStack.cursorStartX = e, this._parseStack.cursorStartY = t, this._parseStack.decodedLength = r, this._parseStack.position = s;
    }
    _logSlowResolvingAsync(e) {
      if (this._logService.logLevel <= 3) {
        let t, r = new Promise((s, o) => {
          t = setTimeout(() => o("#SLOW_TIMEOUT"), 5e3);
        });
        Promise.race([e, r]).then(() => {
          t !== void 0 && clearTimeout(t);
        }, (s) => {
          if (t !== void 0 && clearTimeout(t), s !== "#SLOW_TIMEOUT") throw s;
    ...
    parse(e, t) {
      let r, s = this._activeBuffer.x, o = this._activeBuffer.y, a = 0, l = this._parseStack.paused;
      if (l) {
        if (r = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, t)) return this._logSlowResolvingAsync(r), r;
        s = this._parseStack.cursorStartX, o = this._parseStack.cursorStartY, this._parseStack.paused = false, e.length > 131072 && (a = this._parseStack.position + 131072);
      }
      if (this._logService.logLevel <= 1 && this._logService.debug(`parsing data ${typeof e == "string" ? ` "${e}"` : ` "${Array.prototype.map.call(e, (c) => String.fromCharCode(c)).join("")}"`}`), this._logService.logLevel === 0 && this._logService.trace("parsing data (codes)", typeof e == "string" ? e.split("").map((c) => c.charCodeAt(0)) : e), this._parseBuffer.length < e.length && this._parseBuffer.length < 131072 && (this._parseBuffer = new Uint32Array(Math.min(e.length, 131072))), l || this._dirtyRowTracker.clearRange(), e.length > 131072) for (let c = a; c < e.length; c += 131072) {
        ...
        if (r = this._parser.parse(this._parseBuffer, _)) return this._preserveStack(s, o, _, c), this._logSlowResolvingAsync(r), r;
      }
      else if (!l) {
        let c = typeof e == "string" ? this._stringDecoder.decode(e, this._parseBuffer) : this._utf8Decoder.decode(e, this._parseBuffer);
        if (r = this._parser.parse(this._parseBuffer, c)) return this._preserveStack(s, o, c, 0), this._logSlowResolvingAsync(r), r;
      }
      (this._activeBuffer.x !== s || this._activeBuffer.y !== o) && this._onCursorMove.fire();
    ...
    print(e, t, r) {
      let s, o, a = this._charsetService.charset, l = this._optionsService.rawOptions.screenReaderMode, h = this._bufferService.cols, d = this._coreService.decPrivateModes.wraparound, c = this._coreService.modes.insertMode, u = this._curAttrData, _ = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
      if (!_) return;
      ...
      for (let v = t; v < r; ++v) {
        if (s = e[v], s === 173) continue;
        if (s < 127 && a) {
          let L = a[String.fromCharCode(s)];
          L && (s = L.charCodeAt(0));
        }
        let f = this._unicodeService.charProperties(s, p);
        o = me.extractWidth(f);
        let S = me.extractShouldJoin(f), I = S ? me.extractWidth(p) : 0;
        p = f, l && this._onA11yChar.fire(be(s));
        let w = this._getCurrentLinkId();
        if (w && this._oscLinkService.addLineToLink(w, this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + o - I > h) {
          if (d) {
            let L = _, T = this._activeBuffer.x - I;
            ...
            for (I > 0 && _ instanceof De && _.copyCellsFrom(L, T, 0, I, false); T < h; ) L.setCellFromCodepoint(T++, 0, 1, u);
          } else if (this._activeBuffer.x = h - 1, o === 2) continue;
        }
        if (S && this._activeBuffer.x) {
          let L = _.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
          _.addCodepointToCell(this._activeBuffer.x - L, s, o);
          for (let T = o - I; --T >= 0; ) _.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, u);
          continue;
        }
        if (c && (_.insertCells(this._activeBuffer.x, o - I, this._activeBuffer.getNullCell(u)), _.getWidth(h - 1) === 2 && _.setCellFromCodepoint(h - 1, 0, 1, u)), _.setCellFromCodepoint(this._activeBuffer.x++, s, o, u), o > 0) for (; --o; ) _.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, u);
      }
    ...
    _eraseInBufferLine(e, t, r, s = false, o = false) {
      let a = this._activeBuffer.lines.get(this._activeBuffer.ybase + e);
      a && (a.replaceCells(t, r, this._activeBuffer.getNullCell(this._eraseAttrData()), o), s && (a.isWrapped = false));
    }
      ...
      switch (e.params[0]) {
        ...
        case 1:
          if (r = this._activeBuffer.y, this._dirtyRowTracker.markDirty(r), this._eraseInBufferLine(r, 0, this._activeBuffer.x + 1, true, t), this._activeBuffer.x + 1 >= this._bufferService.cols) {
            let o = this._activeBuffer.lines.get(r + 1);
            o && (o.isWrapped = false);
          }
        ...
        case 3:
          ...
          s > 0 && (this._activeBuffer.lines.trimStart(s), this._activeBuffer.ybase = Math.max(this._activeBuffer.ybase - s, 0), this._activeBuffer.ydisp = Math.max(this._activeBuffer.ydisp - s, 0), this._activeBuffer === this._bufferService.buffers.normal && (this._bufferService.isUserScrolling = false), this._onScroll.fire(0));
          break;
      }
      return true;
    }
    ...
    insertLines(e) {
      ...
      let r = this._activeBuffer.ybase + this._activeBuffer.y, s = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, o = this._bufferService.rows - 1 + this._activeBuffer.ybase - s + 1;
      for (; t--; ) this._activeBuffer.lines.splice(o - 1, 1), this._activeBuffer.lines.splice(r, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
    ...
    deleteLines(e) {
      ...
      let t = e.params[0] || 1;
      if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return true;
      let r = this._activeBuffer.ybase + this._activeBuffer.y, s;
      for (s = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, s = this._bufferService.rows - 1 + this._activeBuffer.ybase - s; t--; ) this._activeBuffer.lines.splice(r, 1), this._activeBuffer.lines.splice(s, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
      return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.y, this._activeBuffer.scrollBottom), this._activeBuffer.x = 0, true;
    }
    insertChars(e) {
      this._restrictCursor();
    ...
    scrollLeft(e) {
      ...
      for (let r = this._activeBuffer.scrollTop; r <= this._activeBuffer.scrollBottom; ++r) {
        let s = this._activeBuffer.lines.get(this._activeBuffer.ybase + r);
    ...
    repeatPrecedingCharacter(e) {
      ...
      if (!t) return true;
      let r = e.params[0] || 1, s = me.extractWidth(t), o = this._activeBuffer.x - s, l = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(o), h = new Uint32Array(l.length * r), d = 0;
      for (let u = 0; u < l.length; ) {
        let _ = l.codePointAt(u) || 0;
        h[d++] = _, u += _ > 65535 ? 2 : 1;
      }
      let c = d;
    ...
    requestMode(e, t) {
      let r;
      ((te) => (te[te.NOT_RECOGNIZED = 0] = "NOT_RECOGNIZED", te[te.SET = 1] = "SET", te[te.RESET = 2] = "RESET", te[te.PERMANENTLY_SET = 3] = "PERMANENTLY_SET", te[te.PERMANENTLY_RESET = 4] = "PERMANENTLY_RESET"))(r ||= {});
      let s = this._coreService.decPrivateModes, { activeProtocol: o, activeEncoding: a } = this._mouseStateService, l = this._coreService, { buffers: h, cols: d } = this._bufferService, { active: c, alt: u } = h, _ = this._optionsService.rawOptions, p = (S, I) => (l.triggerDataEvent(`\x1B[${t ? "" : "?"}${S};${I}$y`), true), v = (S) => S ? 1 : 2, f = e.params[0];
      return t ? f === 2 ? p(f, 4) : f === 4 ? p(f, v(l.modes.insertMode)) : f === 12 ? p(f, 3) : f === 20 ? p(f, v(_.convertEol)) : p(f, 0) : f === 1 ? p(f, v(s.applicationCursorKeys)) : f === 3 ? p(f, _.windowOptions.setWinLines ? d === 80 ? 2 : d === 132 ? 1 : 0 : 0) : f === 6 ? p(f, v(s.origin)) : f === 7 ? p(f, v(s.wraparound)) : f === 8 ? p(f, 3) : f === 9 ? p(f, v(o === "X10")) : f === 12 ? p(f, v(_.cursorBlink)) : f === 25 ? p(f, v(!l.isCursorHidden)) : f === 45 ? p(f, v(s.reverseWraparound)) : f === 66 ? p(f, v(s.applicationKeypad)) : f === 67 ? p(f, 4) : f === 1e3 ? p(f, v(o === "VT200")) : f === 1002 ? p(f, v(o === "DRAG")) : f === 1003 ? p(f, v(o === "ANY")) : f === 1004 ? p(f, v(s.sendFocus)) : f === 1005 ? p(f, 4) : f === 1006 ? p(f, v(a === "SGR")) : f === 1015 ? p(f, 4) : f === 1016 ? p(f, v(a === "SGR_PIXELS")) : f === 1048 ? p(f, 1) : f === 47 || f === 1047 || f === 1049 ? p(f, v(c === u)) : f === 2004 ? p(f, v(s.bracketedPasteMode)) : f === 2026 ? p(f, v(s.synchronizedOutput)) : f === 9001 && this._optionsService.rawOptions.vtExtensions?.win32InputMode ? p(f, v(s.win32InputMode)) : p(f, 0);
    }
    _updateAttrColor(e, t, r, s, o) {
      return t === 2 ? (e |= 50331648, e &= -16777216, e |= ue.fromColorRGB([r, s, o])) : t === 5 && (e &= -67108864, e |= 33554432 | r & 255), e;
    }
    _extractColor(e, t, r) {
      let s = [0, 0, -1, 0, 0, 0], o = 0, a = 0;
      do {
        if (s[a + o] = e.params[t + a], e.hasSubParams(t + a)) {
          let l = e.getSubParams(t + a), h = 0;
          do
            s[1] === 5 && (o = 1), s[a + h + 1 + o] = l[h];
          while (++h < l.length && h + a + 1 + o < s.length);
          break;
        }
        if (s[1] === 5 && a + o >= 2 || s[1] === 2 && a + o >= 5) break;
        s[1] && (o = 1);
      } while (++a + t < e.length && a + o < s.length);
      for (let l = 2; l < s.length; ++l) s[l] === -1 && (s[l] = 0);
      switch (s[0]) {
        case 38:
          r.fg = this._updateAttrColor(r.fg, s[1], s[3], s[4], s[5]);
          break;
        case 48:
          r.bg = this._updateAttrColor(r.bg, s[1], s[3], s[4], s[5]);
          break;
        case 58:
          r.extended = r.extended.clone(), r.extended.underlineColor = this._updateAttrColor(r.extended.underlineColor, s[1], s[3], s[4], s[5]);
      }
      return a;
    }
    ...
    setOrReportIndexedColor(e) {
      let t = [], r = e.split(";");
      for (; r.length > 1; ) {
        let s = r.shift(), o = r.shift();
        if (/^\d+$/.exec(s)) {
          let a = parseInt(s, 10);
          if (Tn(a)) if (o === "?") t.push({ type: 0, index: a });
          else {
            let l = ys(o);
            l && t.push({ type: 1, index: a, color: l });
          }
        }
      }
    ...
    setHyperlink(e) {
      let t = e.indexOf(";");
      if (t === -1) return true;
      let r = e.slice(0, t).trim(), s = e.slice(t + 1);
      return s ? this._createHyperlink(r, s) : r.trim() ? false : this._finishHyperlink();
    }
    _createHyperlink(e, t) {
      this._getCurrentLinkId() && this._finishHyperlink();
      let r = e.split(":"), s, o = r.findIndex((a) => a.startsWith("id="));
      return o !== -1 && (s = r[o].slice(3) || void 0), this._curAttrData.extended = this._curAttrData.extended.clone(), this._curAttrData.extended.urlId = this._oscLinkService.registerLink({ id: s, uri: t }), this._curAttrData.updateExtended(), true;
    }
    _finishHyperlink() {
    ...
    _setOrReportSpecialColor(e, t) {
      let r = e.split(";");
      for (let s = 0; s < r.length && !(t >= this._specialColors.length); ++s, ++t) if (r[s] === "?") this._onColor.fire([{ type: 0, index: this._specialColors[t] }]);
      else {
        let o = ys(r[s]);
        o && this._onColor.fire([{ type: 1, index: this._specialColors[t], color: o }]);
      }
      return true;
    }
    ...
    restoreIndexedColor(e) {
      ...
      let t = [], r = e.split(";");
      for (let s = 0; s < r.length; ++s) if (/^\d+$/.exec(r[s])) {
        let o = parseInt(r[s], 10);
        Tn(o) && t.push({ type: 2, index: o });
      }
      return t.length && this._onColor.fire(t), true;
    }
    restoreFgColor(e) {
    ...
    screenAlignmentPattern() {
      ...
      for (let t = 0; t < this._bufferService.rows; ++t) {
        let r = this._activeBuffer.ybase + this._activeBuffer.y + t, s = this._activeBuffer.lines.get(r);
        s && (s.fill(e), s.isWrapped = false);
      }
      return this._dirtyRowTracker.markAllDirty(), this._setCursor(0, 0), true;
    }
    requestStatusString(e, t) {
      let r = (l) => (this._coreService.triggerDataEvent(`\x1B${l}\x1B\\`), true), s = this._bufferService.buffer, o = this._optionsService.rawOptions, a = { block: 2, underline: 4, bar: 6 };
      return r(e === '"q' ? `P1$r${this._curAttrData.isProtected() ? 1 : 0}"q` : e === '"p' ? 'P1$r61;1"p' : e === "r" ? `P1$r${s.scrollTop + 1};${s.scrollBottom + 1}r` : e === "m" ? "P1$r0m" : e === " q" ? `P1$r${a[o.cursorStyle] - (o.cursorBlink ? 1 : 0)} q` : "P0$r");
    }
    markRangeDirty(e, t) {
    ...
    kittyKeyboardSet(e) {
      ...
      let t = e.params[0] || 0, r = e.length > 1 && e.params[1] || 1, s = this._coreService.kittyKeyboard;
      switch (r) {
        case 1:
          s.flags = t;
          break;
    ...
    kittyKeyboardPush(e) {
      if (!this._optionsService.rawOptions.vtExtensions?.kittyKeyboard) return true;
      let t = e.params[0] || 0, r = this._coreService.kittyKeyboard, o = this._bufferService.buffer === this._bufferService.buffers.alt ? r.altStack : r.mainStack;
      return o.length >= 16 && o.shift(), o.push(r.flags), r.flags = t, true;
    }
    kittyKeyboardPop(e) {
      if (!this._optionsService.rawOptions.vtExtensions?.kittyKeyboard) return true;
      let t = Math.max(1, e.params[0] || 1), r = this._coreService.kittyKeyboard, o = this._bufferService.buffer === this._bufferService.buffers.alt ? r.altStack : r.mainStack;
      for (let a = 0; a < t && o.length > 0; a++) r.flags = o.pop();
      return o.length === 0 && t > 0 && (r.flags = 0), true;
    }
  };
  var hi = class {
    constructor(i) {
  ...
  var vr = class extends g {
    ...
    _innerWrite(e = 0, t = true) {
      ...
      for (; this._writeBuffer.length > this._bufferOffset; ) {
        let s = this._writeBuffer[this._bufferOffset], o = this._action(s, t);
        if (o) {
          let l = (h) => {
            this._store.isDisposed || (performance.now() - r >= 12 ? this._scheduleInnerWrite(0, h) : this._innerWrite(r, h));
          };
          o.catch((h) => (queueMicrotask(() => {
            throw h;
          }), Promise.resolve(false))).then(l);
          return;
        }
        let a = this._callbacks[this._bufferOffset];
        if (a && a(), this._bufferOffset++, this._pendingData -= s.length, performance.now() - r >= 12) break;
      }
  ...
  var kt = class {
    ...
    registerLink(i) {
      let e = this._bufferService.buffer;
      if (i.id === void 0) {
        let l = e.addMarker(e.ybase + e.y), h = { data: i, id: this._nextId++, lines: [l] };
        return l.onDispose(() => this._removeMarkerFromLink(h, l)), this._dataByLinkId.set(h.id, h), h.id;
      }
      let t = i, r = this._getEntryIdKey(t), s = this._entriesWithId.get(r);
      if (s) return this.addLineToLink(s.id, e.ybase + e.y), s.id;
      let o = e.addMarker(e.ybase + e.y), a = { id: this._nextId++, key: this._getEntryIdKey(t), data: t, lines: [o] };
  ...
  var gr = class {
    ...
    _flushInserted() {
      let i = this._insertedValues.sort((s, o) => this._getKey(s) - this._getKey(o)), e = 0, t = 0, r = new Array(this._array.length + this._insertedValues.length);
      for (let s = 0; s < r.length; s++) t >= this._array.length || this._getKey(i[e]) <= this._getKey(this._array[t]) ? (r[s] = i[e], e++) : r[s] = this._array[t++];
    ...
    _flushDeleted() {
      ...
      let i = this._deletedIndices.sort((s, o) => s - o), e = 0, t = new Array(this._array.length - i.length), r = 0;
      for (let s = 0; s < this._array.length; s++) i[e] === s ? e++ : t[r++] = this._array[s];
    ...
    *getKeyIterator(i) {
    ...
    _search(i) {
      ...
      for (; t >= e; ) {
        let r = e + t >> 1, s = this._getKey(this._array[r]);
        if (s > i) t = r - 1;
        else if (s < i) e = r + 1;
        else {
  ...
  var Bt = class extends g {
    ...
    registerDecoration(e) {
      ...
      let t = new ws(e);
      if (t) {
        let r = t.marker.onDispose(() => t.dispose()), s = t.onDispose(() => {
          s.dispose(), t && (this._decorations.delete(t) && (this._lineCache.remove(t), this._onDecorationRemoved.fire(t)), r.dispose());
        });
    ...
    *getDecorationsAtCell(e, t, r) {
      let s = this._lineCache.getDecorationsOnLine(t);
      if (s) for (let o of s) Mt = o.options.x ?? 0, Ir = Mt + (o.options.width ?? 1), e >= Mt && e < Ir && (!r || (o.options.layer ?? "bottom") === r) && (yield o);
    }
    forEachDecorationAtCell(e, t, r, s) {
      let o = this._lineCache.getDecorationsOnLine(t);
      if (o) for (let a of o) Mt = a.options.x ?? 0, Ir = Mt + (a.options.width ?? 1), e >= Mt && e < Ir && (!r || (a.options.layer ?? "bottom") === r) && s(a);
    }
  };
  ...
  var xs = class extends g {
    ...
    _addToLineBuckets(e) {
      ...
      for (let s = t; s < t + r; s++) {
        let o = this._decorationsByLine.get(s);
        o || (o = [], this._decorationsByLine.set(s, o)), o.push(e);
      }
    }
    _removeFromLineBuckets(e) {
      ...
      for (let s = t; s < t + r; s++) {
        ...
        if (!o) continue;
        let a = o.indexOf(e);
        a !== -1 && o.splice(a, 1), o.length === 0 && this._decorationsByLine.delete(s);
      }
    }
    ...
    _handleBufferLinesTrim(e) {
      ...
      for (let [r, s] of this._decorationsByLine) {
        let o = r - e;
        o < 0 || this._mergeLineBucket(t, o, s);
      }
      this._decorationsByLine.clear();
      for (let [r, s] of t) this._decorationsByLine.set(r, s);
    ...
    _mergeLineBucket(e, t, r) {
      let s = e.get(t);
      if (s) for (let o = 0, a = r.length; o < a; o++) s.push(r[o]);
      else e.set(t, r.slice());
    }
    _applyBufferLinesInsert(e) {
      let { index: t, amount: r } = e, s = [];
      for (let a of this._decorations) {
        if (a.marker.isDisposed) continue;
        let l = a._indexedStartLine;
        l < t && l + this._getDecorationHeight(a) > t && (s.push(a), this._removeFromLineBuckets(a));
      }
      let o = /* @__PURE__ */ new Map();
      for (let [a, l] of this._decorationsByLine) {
        let h = a >= t ? a + r : a;
        this._mergeLineBucket(o, h, l);
      }
      this._decorationsByLine.clear();
      for (let [a, l] of o) this._decorationsByLine.set(a, l);
      for (let a of this._decorations) a.marker.isDisposed || a._indexedStartLine >= t && (a._indexedStartLine = a.marker.line);
      for (let a of s) this._addToLineBuckets(a);
    }
    _applyBufferLinesDelete(e) {
      let t = e.index + e.amount, r = /* @__PURE__ */ new Map();
      for (let [o, a] of this._decorationsByLine) {
        if (o >= e.index && o < t) continue;
        let l = o >= t ? o - e.amount : o;
        this._mergeLineBucket(r, l, a);
      }
      this._decorationsByLine.clear();
      for (let [o, a] of r) this._decorationsByLine.set(o, a);
      let s = [];
      for (let o of this._decorations) {
        if (o.marker.isDisposed) continue;
        let a = o._indexedStartLine, l = this._getDecorationHeight(o);
        a >= t ? o._indexedStartLine = o.marker.line : a < e.index && a + l > t && s.push(o);
      }
      for (let o of s) this._reindexDecoration(o);
    }
  };
  ...
  var Cr = class {
    ...
    refresh(i, e, t) {
      ...
      if (r - this._lastRefreshMs >= this._debounceThresholdMS) this._refreshTimeoutID !== void 0 && (clearTimeout(this._refreshTimeoutID), this._refreshTimeoutID = void 0, this._additionalRefreshRequested = false), this._lastRefreshMs = r, this._innerRefresh();
        ...
        let s = r - this._lastRefreshMs, o = this._debounceThresholdMS - s;
  ...
  var Ye = class extends g {
    constructor(e, t, r, s) {
      ...
      Rn ? (this._accessibilityContainer.classList.add("debug"), this._rowContainer.classList.add("debug"), this._debugRootContainer = o.createElement("div"), this._debugRootContainer.classList.add("xterm"), this._debugRootContainer.appendChild(o.createTextNode("------start a11y------")), this._debugRootContainer.appendChild(this._accessibilityContainer), this._debugRootContainer.appendChild(o.createTextNode("------end a11y------")), this._terminal.element.insertAdjacentElement("afterend", this._debugRootContainer)) : this._terminal.element.insertAdjacentElement("afterbegin", this._accessibilityContainer), this._register(this._terminal.onResize((a) => this._handleResize(a.rows))), this._register(this._terminal.onRender((a) => this._refreshRows(a.start, a.end))), this._register(this._terminal.onScroll(() => this._refreshRows())), this._register(this._terminal.onA11yChar((a) => this._handleChar(a))), this._register(this._terminal.onLineFeed(() => this._handleChar(`
...
` && (this._liveRegionLineCount++, this._liveRegionLineCount === 21 && (this._liveRegion.textContent = Ze.get())));
    ...
    _renderRows(e, t) {
      let r = this._terminal.buffer, s = r.lines.length.toString();
      for (let o = e; o <= t; o++) {
        let a = r.lines.get(r.ydisp + o), l = [], h = a?.translateToString(true, void 0, void 0, l) || "", d = (r.ydisp + o + 1).toString(), c = this._rowElements[o];
        c && (h.length === 0 ? (c.textContent = "\xA0", this._rowColumns.set(c, [0, 1])) : (c.textContent = h, this._rowColumns.set(c, l)), c.setAttribute("aria-posinset", d), c.setAttribute("aria-setsize", s), this._alignRowWidth(c));
      }
    ...
    _handleBoundaryFocus(e, t) {
      let r = e.target, s = this._rowElements[t === 0 ? 1 : this._rowElements.length - 2], o = r.getAttribute("aria-posinset"), a = t === 0 ? "1" : `${this._terminal.buffer.lines.length}`;
      if (o === a || e.relatedTarget !== s) return;
      let l, h;
      if (t === 0 ? (l = r, h = this._rowElements.pop(), this._rowContainer.removeChild(h)) : (l = this._rowElements.shift(), h = r, this._rowContainer.removeChild(l)), l.removeEventListener("focus", this._topBoundaryFocusListener), h.removeEventListener("focus", this._bottomBoundaryFocusListener), t === 0) {
    ...
    _handleSelectionChange() {
      ...
      if (r.node.compareDocumentPosition(s) & (Node.DOCUMENT_POSITION_CONTAINED_BY | Node.DOCUMENT_POSITION_PRECEDING) && (r = { node: s, offset: s.textContent?.length ?? 0 }), !this._rowContainer.contains(r.node)) return;
      let o = ({ node: h, offset: d }) => {
    ...
    _alignRowWidth(e) {
      ...
      if (!r) return;
      let s = r * this._renderService.dimensions.css.cell.width;
  ...
  var Pt = class extends g {
    ...
    _askForLink(e, t) {
      ...
      let r = false;
      for (let [s, o] of this._linkProviderService.linkProviders.entries()) t ? this._activeProviderReplies?.get(s) && (r = this._checkLinkProviderResult(s, e, r)) : o.provideLinks(e.y, (a) => {
        if (this._isMouseOut) return;
        let l = a?.map((h) => ({ link: h }));
        this._activeProviderReplies?.set(s, l), r = this._checkLinkProviderResult(s, e, r), this._activeProviderReplies?.size === this._linkProviderService.linkProviders.length && this._removeIntersectingLinks(e.y, this._activeProviderReplies);
      });
    }
    _removeIntersectingLinks(e, t) {
      ...
      for (let s = 0; s < t.size; s++) {
        ...
        if (o) for (let a = 0; a < o.length; a++) {
          let l = o[a], h = l.link.range.start.y < e ? 0 : l.link.range.start.x, d = l.link.range.end.y > e ? this._bufferService.cols : l.link.range.end.x;
          for (let c = h; c <= d; c++) {
            if (r.has(c)) {
              o.splice(a--, 1);
              break;
    ...
    _checkLinkProviderResult(e, t, r) {
      ...
      let s = this._activeProviderReplies.get(e), o = false;
      for (let a = 0; a < e; a++) (!this._activeProviderReplies.has(a) || this._activeProviderReplies.get(a)) && (o = true);
      if (!o && s) {
        let a = s.find((l) => this._linkAtPosition(l.link, t));
      ...
      if (this._activeProviderReplies.size === this._linkProviderService.linkProviders.length && !r) for (let a = 0; a < this._activeProviderReplies.size; a++) {
        let l = this._activeProviderReplies.get(a)?.find((h) => this._linkAtPosition(h.link, t));
        if (l) {
          r = true, this._handleNewLink(l);
          break;
        }
      }
      return r;
    ...
    _handleNewLink(e) {
      ...
      t && this._linkAtPosition(e.link, t) && (this._currentLink = e, this._currentLink.state = { decorations: { underline: e.link.decorations === void 0 ? true : e.link.decorations.underline, pointerCursor: e.link.decorations === void 0 ? true : e.link.decorations.pointerCursor }, isHovered: true }, this._linkHover(this._element, e.link, this._lastMouseEvent), e.link.decorations = {}, Object.defineProperties(e.link.decorations, { pointerCursor: { get: () => this._currentLink?.state?.decorations.pointerCursor, set: (r) => {
        ...
        if (!this._currentLink) return;
        let s = r.start === 0 ? 0 : r.start + 1 + this._bufferService.buffer.ydisp, o = this._bufferService.buffer.ydisp + 1 + r.end;
        if (this._currentLink.link.range.start.y >= s && this._currentLink.link.range.end.y <= o && (this._clearCurrentLink(s, o), this._lastMouseEvent)) {
    ...
    _fireUnderlineEvent(e, t) {
      let r = e.range, s = this._bufferService.buffer.ydisp, o = this._createLinkUnderlineEvent(r.start.x - 1, r.start.y - s - 1, r.end.x, r.end.y - s - 1, void 0);
      (t ? this._onShowLinkUnderline : this._onHideLinkUnderline).fire(o);
    }
    _linkLeave(e, t, r) {
    ...
    _linkAtPosition(e, t) {
      let r = e.range.start.y * this._bufferService.cols + e.range.start.x, s = e.range.end.y * this._bufferService.cols + e.range.end.x, o = t.y * this._bufferService.cols + t.x;
      return r <= o && o <= s;
    }
    ...
    _createLinkUnderlineEvent(e, t, r, s, o) {
      return { x1: e, y1: t, x2: r, y2: s, cols: this._bufferService.cols, fg: o };
    }
  };
  ...
  var Er = class extends Sr {
    ...
    _handleColorEvent(e) {
      if (this._themeService) for (let t of e) {
        ...
        switch (t.type) {
          case 0:
            let o = k.toColorRGB(r === "ansi" ? this._themeService.colors.ansi[t.index] : this._themeService.colors[r]);
            this.coreService.triggerDataEvent(`\x1B]${s};${En(o)}\x1B\\`);
            break;
          case 1:
            if (r === "ansi") this._themeService.modifyColors((a) => a.ansi[t.index] = O.toColor(...t.color));
            else {
              let a = r;
              this._themeService.modifyColors((l) => l[a] = O.toColor(...t.color));
            }
            break;
          case 2:
    ...
    _syncTextArea() {
      ...
      if (!t) return;
      let r = Math.min(this.buffer.x, this.cols - 1), s = this._renderService.dimensions.css.cell.height, o = t.getWidth(r), a = this._renderService.dimensions.css.cell.width * o, l = this.buffer.y * this._renderService.dimensions.css.cell.height, h = r * this._renderService.dimensions.css.cell.width;
      this.textarea.style.left = h + "px", this.textarea.style.top = l + "px", this.textarea.style.width = a + "px", this.textarea.style.height = s + "px", this.textarea.style.lineHeight = s + "px", this.textarea.style.zIndex = "-5";
    }
    _initGlobal() {
    ...
    open(e) {
      ...
      this._document = e.ownerDocument, this.options.documentOverride && this.options.documentOverride instanceof Document && (this._document = this.optionsService.rawOptions.documentOverride), this.element = this._document.createElement("div"), this.element.dir = "ltr", this.element.classList.add("terminal"), this.element.classList.add("xterm"), this.element.classList.toggle("allow-transparency", this.options.allowTransparency), this._register(this.optionsService.onSpecificOptionChange("allowTransparency", (l) => this.element.classList.toggle("allow-transparency", l))), e.appendChild(this.element);
      let t = this._document.createDocumentFragment();
      this._viewportElement = this._document.createElement("div"), this._viewportElement.classList.add("xterm-viewport"), t.appendChild(this._viewportElement), this.screenElement = this._document.createElement("div"), this.screenElement.classList.add("xterm-screen"), this._register(C(this.screenElement, "mousemove", (l) => this.updateCursorStyle(l))), this._helperContainer = this._document.createElement("div"), this._helperContainer.classList.add("xterm-helpers"), this.screenElement.appendChild(this._helperContainer), t.appendChild(this.screenElement);
      ...
      let s = this._linkifier.value = this._register(this._instantiationService.createInstance(Pt, this.screenElement));
      this.element.appendChild(t);
      try {
        this._onWillOpen.fire(this.element);
      } catch (l) {
        this._logService.error("onWillOpen handler threw an exception", l);
      }
      this._renderService.hasRenderer() || this._renderService.setRenderer(this._createRenderer()), this._register(this.onCursorMove(() => {
      ...
      })), this._register(this.onBlur(() => this._renderService.handleBlur())), this._register(this.onFocus(() => this._renderService.handleFocus())), this._viewport = this._register(this._instantiationService.createInstance(dt, this.element, this.screenElement)), this._register(this._viewport.onRequestScrollLines((l) => {
        super.scrollLines(l, false), this.refresh(0, this.rows - 1);
        ...
        this.textarea.value = l, this.textarea.focus(), this.textarea.select();
      ...
      let o = this.options.scrollbar?.showScrollbar ?? true, a = this.options.scrollbar?.width;
      o && a && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(ze, this._viewportElement, this.screenElement))), this.optionsService.onSpecificOptionChange("scrollbar", (l) => {
        let h = (l?.showScrollbar ?? true) && !!l?.width;
      ...
      }), this._charSizeService.measure(), this.refresh(0, this.rows - 1), this._initGlobal(), this._mouseService.bindMouse({ element: this.element, screenElement: this.screenElement, document: this._document, handleTouchScroll: (l) => this._viewport?.handleTouchScroll(l) }, (l) => this._register(l), () => this.focus());
    }
    _createRenderer() {
    ...
    _keyDown(e) {
      ...
      if (this.updateCursorStyle(e), r.type === 3 || r.type === 2) {
        let o = this.rows - 1;
        return this.scrollLines(r.type === 2 ? -o : o), e.preventDefault(), e.stopPropagation(), false;
      }
      ...
      let s = this._keyboardService.useWin32InputMode && Ts(e);
      if (this._onKey.fire({ key: r.key, domEvent: e }), this._showCursor(), this.coreService.triggerDataEvent(r.key, !s), !this.optionsService.rawOptions.screenReaderMode || e.altKey || e.ctrlKey) return e.preventDefault(), e.stopPropagation(), false;
    ...
    _reportWindowsOptions(e) {
      if (this._renderService) switch (e) {
        case 0:
          ...
          break;
        case 1:
          let s = this._renderService.dimensions.css.cell.width.toFixed(0), o = this._renderService.dimensions.css.cell.height.toFixed(0);
          this.coreService.triggerDataEvent(`\x1B[6;${o};${s}t`);
          break;
      }
    }
  };
  ...
  var Ln = class extends g {
    constructor(i) {
      ...
      let e = (r) => this._core.options[r], t = (r, s) => {
...
`, e);
  ...
  // src/renderer/src/imeAnchor.ts
  var VIEW_PROPS = ["left", "top", "height", "line-height", "max-width", "overflow", "direction"];
  var TEXTAREA_PROPS = ["left", "top", "width", "height", "line-height"];
  var SHELL_PROMPT_RE = /^\s*(?:PS\s+)?[^│┃|]*[>»›$#%❯]\s*\S*$/;
  function attachImeAnchor(terminal, options = {}) {
    const { onAnchor, requireIsolatedCell = true, maxRowDistance = 10 } = options;
    const root = terminal.element;
    if (!root) return { detach() {
    } };
    const textarea2 = root.querySelector(".xterm-helper-textarea");
    const screen = root.querySelector(".xterm-screen");
    const compositionView = root.querySelector(".composition-view");
    if (!textarea2 || !screen || !compositionView) return { detach() {
    } };
      ...
      for (let y2 = startY; y2 < startY + terminal.rows; y2++) {
        ...
        for (let x = 0; x < line.length; x++) {
          ...
          if (requireIsolatedCell) {
            const left = x > 0 ? line.getCell(x - 1) : void 0;
            const right = x + 1 < line.length ? line.getCell(x + 1) : void 0;
            if (left?.isInverse() && right?.isInverse()) continue;
          }
          best = { col: x, row: y2 - startY, dist };
          break;
        }
      }
    ...
    function applyLayout() {
      if (!anchor) return;
      const view2 = compositionView;
      const ta = textarea2;
      view2.style.setProperty("left", `${anchor.left}px`, "important");
      view2.style.setProperty("top", `${anchor.top}px`, "important");
      view2.style.setProperty("height", `${anchor.cellHeight}px`, "important");
      view2.style.setProperty("line-height", `${anchor.cellHeight}px`, "important");
      const opts = terminal.options;
      if (opts.fontFamily) view2.style.setProperty("font-family", opts.fontFamily, "important");
      if (opts.fontSize) view2.style.setProperty("font-size", `${opts.fontSize}px`, "important");
      view2.style.setProperty("max-width", `${anchor.maxWidth}px`, "important");
      view2.style.setProperty("overflow", "hidden", "important");
      view2.style.setProperty("direction", "rtl", "important");
      const b2 = view2.getBoundingClientRect();
      ta.style.setProperty("left", `${anchor.left}px`, "important");
      ta.style.setProperty("top", `${anchor.top}px`, "important");
      ta.style.setProperty("width", `${Math.max(b2.width, 1)}px`, "important");
      ta.style.setProperty("height", `${Math.max(b2.height, 1)}px`, "important");
      ta.style.setProperty("line-height", `${Math.max(b2.height, 1)}px`, "important");
    }
    function releaseOverrides() {
      for (const p of VIEW_PROPS) compositionView.style.removeProperty(p);
      for (const p of TEXTAREA_PROPS) textarea2.style.removeProperty(p);
    }
    let restoreHelper = null;
    ...
    textarea2.addEventListener("compositionstart", onCompositionStart);
    textarea2.addEventListener("compositionend", onCompositionEnd);
    return {
      detach() {
        composing = false;
        anchor = null;
        ...
        renderDisposable = null;
        restoreHelper?.();
        textarea2.removeEventListener("compositionstart", onCompositionStart);
        textarea2.removeEventListener("compositionend", onCompositionEnd);
      }
    };
  }

  // scripts/ime-test/harness.ts
  var ESC = String.fromCharCode(27);
  var INV_ON = `${ESC}[7m`;
  var INV_OFF = `${ESC}[27m`;
  var container = document.getElementById("term");
  var term = new Ln({ fontSize: 14, rows: 24, cols: 100 });
  term.open(container);
  var anchors = [];
  ...
  window.imeTest = {
    ...
    drawFrame(caretAboveCursor) {
      ...
      caretAbsRow = b2.baseY + b2.cursorY + 1;
      let s = `\r
> ${INV_ON} ${INV_OFF}`;
...
yolo  K3-256k thinking: high  ~  context: 0% (0/256k) line ${i}`;
    ...
    fillScrollback(lines) {
      let s = "";
      for (let i = 0; i < lines; i++) s += `scroll filler ${i}\r
`;
      term.write(s);
    },
    resetAnchors() {
    ...
    measure() {
      ...
      return JSON.stringify({
        ...
        cellW,
        caretAbsRow,
        caretViewportRow: caretAbsRow - b2.viewportY,
        expectedLeft: Math.round(screen.left + CARET_COL * cellW),
        caretCol: CARET_COL,
        cursor: { x: b2.cursorX, y: b2.cursorY, absY: b2.baseY + b2.cursorY },
        viewportY: b2.viewportY,
        baseY: b2.baseY,
        cols: term.cols,
        rows: term.rows
      });
